...
function Avatar$1(_ref) {
    ...
    var className = styles.classNames(styles$1.Avatar, styles$1[styles.variationName('style', styleClass(nameString))], size && styles$1[styles.variationName('size', size)], finalSource && styles$1.hasImage);
...
var Card$1 = function (_React$PureComponent) {
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            var headerMarkup = title ? React.createElement(Header$1, { actions: actions, title: title }) : null;
...
function TextStyle$1(_ref) {
    ...
    var className = styles.classNames(variation && styles$12[styles.variationName('variation', variation)], variation === Variations.Code && styles$12.code);
...
function Item$6(_ref) {
  ...
  var className = reactUtilities.classNames(styles$16.Item, disabled && styles$16.disabled, destructive && styles$16.destructive);
...
function Section$3(_ref) {
    ...
    var actionMarkup = section.items.map(function (_a, index) {
        ...
        return React.createElement(Item$6, Object.assign({ key: content + '-' + index, content: content, onAction: handleAction(onAction) }, item));
    });
...
var Banner$1 = function (_React$PureComponent) {
    ...
    _createClass(Banner, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$17.Banner, status && styles$17[styles.variationName('status', status)], onDismiss && styles$17.hasDismiss, withinContentContainer ? styles$17.withinContentContainer : styles$17.withinPage);
            var id = uniqueID();
...
function TextContainer$1(_ref) {
    ...
    var className = styles.classNames(styles$18.TextContainer, spacing && styles$18[styles.variationName('spacing', spacing)]);
    return React.createElement(
        'div',
        { className: className },
        children
...
function Choice$1(_ref) {
  ...
  var className = styles.classNames(styles$22.Choice, labelHidden && styles$22.labelHidden, disabled && styles$22.disabled);
...
function Checkbox$1(_ref) {
    ...
    var wrapperClassName = styles.classNames(styles$23.Checkbox, error && styles$23.error);
    ...
    var inputClassName = styles.classNames(styles$23.Input, isIndeterminate && styles$23['Input-indeterminate']);
    return (
...
function ChoiceList$1(_ref) {
    ...
    var className = styles.classNames(styles$25.ChoiceList, titleHidden && styles$25.titleHidden);
...
var Collapsible$1 = function (_React$Component) {
    ...
    _createClass(Collapsible, [{
        ...
        value: function render() {
            ...
            var wrapperClassName = styles.classNames(styles$26.Collapsible, open && styles$26.open, animating && styles$26.animating);
    ...
    _createClass(AlphaPicker, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement('div', { className: styles$27.ColorLayer, style: { background: background } }),
...
var Item$8 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$28.Item, focused && styles$28['Item-focused'], position === ItemPosition.Primary ? styles$28['Item-primary'] : styles$28['Item-connection']);
            return React.createElement(
                'div',
...
function Cell$1(_ref) {
  ...
  var className = styles.classNames(styles$29.Cell, fixed && styles$29['Cell-fixed'], fixed && truncate && styles$29['Cell-truncated'], header && styles$29['Cell-header'], total && styles$29['Cell-total'], footer && styles$29['Cell-footer'], numeric && styles$29['Cell-numeric'], sortable && styles$29['Cell-sortable'], sorted && styles$29['Cell-sorted']);
  var headerClassName = styles.classNames(header && styles$29.Heading, header && contentType === 'text' && styles$29['Heading-left']);
  var iconClassName = styles.classNames(sortable && styles$29.Icon);
  var style = {
...
function Navigation$1(_ref) {
    ...
    var pipMarkup = columnVisibilityData.map(function (column, index) {
        var className = styles.classNames(styles$29.Pip, column.isVisible && styles$29['Pip-visible']);
...
var DataTable$1 = function (_React$PureComponent) {
    ...
    _createClass(DataTable, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$29.DataTable, collapsed && styles$29.collapsed, footerContent && styles$29.hasFooter);
            var wrapperClassName = styles.classNames(styles$29.TableWrapper, collapsed && styles$29.collapsed);
            var footerClassName = styles.classNames(footerContent && styles$29.TableFoot);
        ...
        value: function defaultRenderRow(row, index) {
            var className = styles.classNames(styles$29.TableRow);
            var _props4 = this.props,
...
var Day$1 = function (_React$PureComponent) {
    ...
    _createClass(Day, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$30.Day, selected && styles$30['Day-selected'], disabled && styles$30['Day-disabled'], today && styles$30['Day-today'], (inRange || inHoveringRange) && !disabled && styles$30['Day-inRange']);
...
function Weekday$1(_ref) {
    ...
    var className = styles.classNames(styles$30.Weekday, current && styles$30['Weekday-current']);
    return React.createElement(
        'div',
...
function Month$1(_ref) {
    ...
    var className = styles.classNames(styles$30.Title, current && styles$30['Month-current']);
...
function DisplayText$1(_ref) {
    ...
    var className = styles.classNames(styles$32.DisplayText, size && styles$32[styles.variationName('size', size)]);
    return React.createElement(
        Element,
        { className: className },
        children
...
function Label$1(_ref) {
    ...
    var className = styles.classNames(styles$33.Label, hidden && styles$33.hidden);
    return React.createElement(
        'div',
        { className: className },
        React.createElement(
...
function Labelled$1(_a) {
  ...
  var className = styles.classNames(labelHidden && styles$34.hidden);
...
var FileUpload$1 = function (_React$Component) {
    ...
    _createClass(FileUpload, [{
        ...
        value: function render() {
            ...
            var imageClasses = styles.classNames(styles$36.Image, size && size === 'extraLarge' && styles$36.sizeExtraLarge, size && size === 'large' && styles$36.sizeLarge);
...
var DropZone$1 = function (_React$Component) {
    ...
    _createClass(DropZone, [{
        ...
        value: function render() {
            ...
            var classes = styles.classNames(styles$37.DropZone, outline && styles$37.hasOutline, (active || dragging) && styles$37.isDragging, error && styles$37.hasError, size && size === 'extraLarge' && styles$37.sizeExtraLarge, size && size === 'large' && styles$37.sizeLarge, size && size === 'medium' && styles$37.sizeMedium, size && size === 'small' && styles$37.sizeSmall);
...
var EmptySearchResult$1 = function (_React$PureComponent) {
    ...
    _createClass(EmptySearchResult, [{
        ...
        value: function render() {
            ...
            var illustrationMarkup = withIllustration ? React.createElement(Image$1, { alt: altText, source: emptySearch, className: styles$38.Image, draggable: false }) : null;
            return React.createElement(
                Stack$1,
...
var EmptyState$1 = function (_React$PureComponent) {
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      ...
      var className = styles.classNames(styles$39.EmptyState, imageContained && styles$39.imageContained);
      var imageMarkup = largeImage ? React.createElement(Image$1, { alt: '', role: 'presentation', className: styles$39.Image, source: largeImage, sourceSet: [{ source: image, descriptor: '568w' }, { source: largeImage, descriptor: '1136w' }], sizes: '(max-width: 568px) 60vw' }) : React.createElement(Image$1, { role: 'presentation', alt: '', className: styles$39.Image, source: image });
      var secondaryActionMarkup = secondaryAction ? buttonFrom(secondaryAction, { plain: true }) : null;
      return React.createElement(
        'div',
        { className: className },
...
function ExceptionList$1(_ref) {
  ...
  var items = itemsList.map(function (item, index) {
    ...
    var itemClasses = styles.classNames(styles$41.Item, status && styles$41[styles.variationName('status', status)]);
    var iconMarkup = icon ? React.createElement(Icon$2, { source: icon }) : React.createElement('span', { className: styles$41.Bullet });
    var titleMarkup = title && React.createElement(
      'span',
...
function Group$1(_ref) {
    ...
    var className = styles.classNames(condensed && styles$43.condensed);
...
function Section$5(_ref) {
    ...
    var className = styles.classNames(styles$45.Section, secondary && styles$45['Section-secondary'], fullWidth && styles$45['Section-fullWidth']);
    return React.createElement(
        'div',
        { className: className },
        children
...
var Option$1 = function (_React$Component) {
    ...
    _createClass(Option, [{
        ...
        value: function render() {
            ...
            var singleSelectClassName = styles.classNames(styles$52.SingleSelectOption, focused && styles$52.focused, disabled && styles$52.disabled, select && styles$52.select, active && styles$52.active);
            var multiSelectClassName = styles.classNames(styles$52.Label, active && styles$52.active);
...
function Action$1(_ref) {
  ...
  var indicatorMarkup = false && showIndicator && !hasIndicator && React.createElement(Indicator$1, null);
  var className = reactUtilities.classNames(styles$55.Action, disabled && styles$55.disabled, icon && children == null && styles$55.iconOnly, false && showIndicator && styles$55['Action-outline']);
  return React.createElement(
    'button',
...
var Scrollable$1 = function (_React$Component) {
    ...
    _createClass(Scrollable, [{
        ...
        value: function render() {
            ...
            var finalClassName = styles.classNames(className, styles$57.Scrollable, vertical && styles$57.vertical, horizontal && styles$57.horizontal, topShadow && styles$57.hasTopShadow, bottomShadow && styles$57.hasBottomShadow);
            return React.createElement(
                'div',
...
var PositionedOverlay$1 = function (_React$PureComponent) {
    ...
    _createClass(PositionedOverlay, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$58.PositionedOverlay, fixed && styles$58.fixed);
            return React.createElement(
                'div',
...
var TooltipOverlay$1 = function (_React$PureComponent) {
    ...
    _createClass(TooltipOverlay, [{
        ...
        value: function renderTooltip(overlayDetails) {
            ...
            var containerClassName = styles.classNames(styles$59.Tooltip, light && styles$59.light, measuring && styles$59.measuring, positioning === 'above' && styles$59.positionedAbove);
            var contentStyles = measuring ? undefined : { maxHeight: desiredHeight };
            var tipMarkup = !measuring ? React.createElement('div', { style: tipStyle, className: styles$59.Tip }) : null;
            return React.createElement(
                'div',
...
var getUniqueID$7 = other.createUniqueIDFactory('TooltipContent');
...
function Pagination$1(_ref) {
    ...
    var className = reactUtilities.classNames(styles$60.Pagination, plain && styles$60.plain);
    ...
    var previousButtonEvents = previousKeys && (previousURL || onPrevious) && previousKeys.map(function (key) {
        return React.createElement(KeypressListener$1, { key: key, keyCode: key, handler: previousURL ? clickPaginationLink('previousURL') : onPrevious });
    });
    var nextButtonEvents = nextKeys && (nextURL || onNext) && nextKeys.map(function (key) {
        return React.createElement(KeypressListener$1, { key: key, keyCode: key, handler: nextURL ? clickPaginationLink('nextURL') : onNext });
    });
    return React.createElement(
        'nav',
...
function Pane$1(_ref) {
    ...
    var className = styles.classNames(styles$61.Pane, fixed && styles$61['Pane-fixed']);
...
var PopoverOverlay$1 = function (_React$PureComponent) {
    ...
    _createClass(PopoverOverlay, [{
        ...
        value: function renderPopover(transitionStatus, overlayDetails) {
            ...
            var className = styles.classNames(styles$61.Popover, transitionStatus && animationVariations(transitionStatus), positioning === 'above' && styles$61.positionedAbove, fullWidth && styles$61.fullWidth, measuring && styles$61.measuring);
            this.transitionStatus = transitionStatus;
            var tipMarkup = !measuring ? React.createElement('div', { style: { left: activatorRect.center.x - left }, className: styles$61.Tip }) : null;
            var contentStyles = measuring ? undefined : { height: desiredHeight };
            var contentClassNames = styles.classNames(styles$61.Content, fullHeight && styles$61['Content-fullHeight']);
...
var getUniqueID$9 = other.createUniqueIDFactory('Popover');
    ...
    _createClass(Header, [{
        ...
        value: function renderSecondaryActions() {
            ...
            var actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(function (_ref) {
                ...
                var detailsClassName = styles.classNames(styles$55.Details, actions && Array.isArray(actions) && actions.length > 0 && styles$55.withActions);
                var detailsMarkup = details ? React.createElement(
                    'div',
                ...
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        { key: title, active: active
                            // eslint-disable-next-line react/jsx-no-bind
                            , onClose: _this2.handleActionGroupClose.bind(_this2, title), activator: React.createElement(
                                Action$1,
...
var Page$1 = function (_React$PureComponent) {
    ...
    _createClass(Page, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$55.Page, fullWidth && styles$55.fullWidth, singleColumn && styles$55.singleColumn);
            var headerMarkup = this.props.polaris.easdk || !this.hasHeaderContent() ? null : React.createElement(Header$5, rest);
            return React.createElement(
                'div',
                { className: className },
                headerMarkup,
...
var getUniqueID$10 = other.createUniqueIDFactory('RangeSlider');
...
var RangeSlider$1 = function (_React$PureComponent) {
    ...
    _createClass(RangeSlider, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$63.RangeSlider, error && styles$63.error, disabled && styles$63.disabled);
            return React.createElement(
                Labelled$1,
...
function Select$1(_ref) {
    ...
    var className = styles.classNames(styles$64.Select, error && styles$64.error, disabled && styles$64.disabled);
...
function CheckableButton$1(_ref) {
    ...
    var className = plain ? styles.classNames(styles$65.CheckableButton, styles$65['CheckableButton-plain']) : styles.classNames(styles$65.CheckableButton, selectMode && styles$65['CheckableButton-selectMode'], selected && styles$65['CheckableButton-selected'], measuring && styles$65['CheckableButton-measuring']);
    return React.createElement(
        'div',
...
var BulkActionButton = function (_React$PureComponent) {
    ...
    _createClass(BulkActionButton, [{
        ...
        value: function render() {
            ...
            var className = reactUtilities.classNames(styles$66.Button, disabled && styles$66.disabled);
            return React.createElement(
                'button',
...
var BulkActions$1 = function (_React$PureComponent) {
    ...
    _createClass(BulkActions, [{
        ...
        value: function render() {
            ...
            var cancelButtonClassName = styles.classNames(styles$66.Button, styles$66['Button-cancel']);
            ...
            var promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0 ? [].concat(_toConsumableArray(promotedActions)).slice(0, numberOfPromotedActionsToRender).map(function (action, index) {
                return React.createElement(BulkActionButton, Object.assign({}, action, { key: index, handleMeasurement: _this2.handleMeasurement }));
            }) : null;
            ...
            var smallScreenGroup = React.createElement(
                ...
                function (status) {
                    var smallScreenGroupClassName = styles.classNames(styles$66.Group, styles$66['Group-smallScreen'], styles$66['Group-' + status]);
                    return React.createElement(
                        'div',
            ...
            var largeScreenGroup = React.createElement(
                ...
                function (status) {
                    var largeScreenGroupClassName = styles.classNames(styles$66.Group, styles$66['Group-largeScreen'], !measuring && styles$66['Group-' + status], measuring && styles$66['Group-measuring']);
                    return React.createElement(
                        'div',
...
var FilterCreator = function (_React$PureComponent) {
    ...
    _createClass(FilterCreator, [{
        ...
        value: function render() {
            ...
            var filterValueSelectionMarkup = selectedFilter ? React.createElement(FilterValueSelector$1, { filter: selectedFilter, filterKey: selectedFilterKey, value: selectedFilterValue, onFilterKeyChange: this.handleFilterKeyChange, onChange: this.handleFilterValueChange }) : null;
...
var FilterControl$1 = function (_React$Component) {
    ...
    _createClass(FilterControl, [{
        ...
        value: function render() {
            ...
            var filterCreatorMarkup = filters.length > 0 ? React.createElement(FilterCreator$1, { resourceName: resourceName, filters: filters, onAddFilter: this.handleAddFilter, disabled: selectMode }) : null;
...
var Item$15 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$69.Item, focused && styles$69.focused, selectable && styles$69.selectable, selected && styles$69.selected, selectMode && styles$69.selectMode, persistActions && styles$69.persistActions, focusedInner && styles$69.focusedInner);
            ...
            var accessibleMarkup = url ? React.createElement(UnstyledLink$2, { 'aria-describedby': this.props.id, 'aria-label': accessibilityLabel, className: styles$69.Link, url: url, onFocus: this.handleAnchorFocus, onBlur: this.handleFocusedBlur }) : React.createElement('button', { className: styles$69.Button, 'aria-label': accessibilityLabel, 'aria-controls': ariaControls, 'aria-expanded': ariaExpanded, onClick: this.handleClick, onFocus: this.handleAnchorFocus, onBlur: this.handleFocusedBlur });
            return React.createElement(
                'div',
...
tslib_1.__decorate([decorators.autobind], Item$15.prototype, "handleContextUpdate", null);
...
var ResourceList$1 = function (_React$Component) {
    ...
    _createClass(ResourceList, [{
        ...
        value: function render() {
            ...
            var itemCountTextMarkup = React.createElement(
                'div',
            ...
            var headerMarkup = (showHeader || needsHeader) && listNode && itemsExist && React.createElement(
                'div',
                ...
                React.createElement(
                    ...
                    function (isSticky) {
                        var headerClassName = styles.classNames(styles$70.HeaderWrapper, sortOptions && sortOptions.length > 0 && styles$70['HeaderWrapper-hasSort'], _this2.selectable && styles$70['HeaderWrapper-hasSelect'], _this2.selectable && selectMode && styles$70['HeaderWrapper-inSelectMode'], isSticky && styles$70['HeaderWrapper-isSticky']);
                        return React.createElement(
                            'div',
            ...
            var emptyStateMarkup = filterControl && !itemsExist ? React.createElement(
                'div',
...
var Item$18 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$71.Item);
            return React.createElement(
                'li',
                { role: 'presentation' },
                React.createElement(
...
var Tab$1 = function (_React$PureComponent) {
    ...
    _createClass(Tab, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$71.Tab, selected && styles$71['Tab-selected']);
            var tabIndex = void 0;
...
var TabMeasurer$1 = function (_React$PureComponent) {
    ...
    _createClass(TabMeasurer, [{
        ...
        value: function render() {
            ...
            var classname = styles.classNames(styles$71.Tabs, styles$71.TabMeasurer);
            return React.createElement(
                'div',
...
var Tabs$1 = function (_React$PureComponent) {
    ...
    _createClass(Tabs, [{
        ...
        value: function render() {
            ...
            var classname = styles.classNames(styles$71.Tabs, fitted && styles$71.fitted, disclosureActivatorVisible && styles$71.fillSpace);
            var disclosureTabClassName = styles.classNames(styles$71.DisclosureTab, disclosureActivatorVisible && styles$71['DisclosureTab-visible']);
            var activator = React.createElement(
                'button',
...
function Tag$1(_ref) {
  ...
  var className = reactUtilities.classNames(disabled && styles$72.disabled, styles$72.Tag);
...
var Resizer$1 = function (_React$PureComponent) {
    ...
    _createClass(Resizer, [{
        ...
        value: function render() {
            ...
            var minimumLinesMarkup = minimumLines ? React.createElement('div', { ref: this.setMinimumLinesNode, className: styles$73.DummyInput, dangerouslySetInnerHTML: {
...
var getUniqueID$13 = other.createUniqueIDFactory('TextField');
...
var TextField$1 = function (_React$PureComponent) {
    ...
    _createClass(TextField, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$73.TextField, Boolean(value) && styles$73.hasValue, disabled && styles$73.disabled, readOnly && styles$73.readOnly, error && styles$73.error, multiline && styles$73.multiline, this.state.focus && styles$73.focus);
            ...
            var spinnerMarkup = type === 'number' && !disabled ? React.createElement(Spinner$4, { onChange: this.handleNumberChange }) : null;
            ...
            var inputClassName = styles.classNames(styles$73.Input, suffix && styles$73['Input-suffixed']);
...
function Thumbnail$1(_ref) {
    ...
    var className = styles.classNames(styles$74.Thumbnail, size && styles$74[styles.variationName('size', size)]);
    return React.createElement(
        'span',
        { className: className },
...
function SkeletonDisplayText$1(_ref) {
    ...
    var className = styles.classNames(styles$75.DisplayText, size && styles$75[styles.variationName('size', size)]);
...
var SkeletonPage = function (_React$PureComponent) {
    ...
    _createClass(SkeletonPage, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$77.Page, fullWidth && styles$77.fullWidth, singleColumn && styles$77.singleColumn);
            var headerClassName = styles.classNames(styles$77.Header, secondaryActions && styles$77['Header-hasSecondaryActions'], breadcrumbs && styles$77['Header-hasBreadcrumbs']);
...
function ProgressBar$1(_ref) {
    ...
    var className = styles.classNames(styles$78.ProgressBar, size && styles$78[styles.variationName('size', size)]);
