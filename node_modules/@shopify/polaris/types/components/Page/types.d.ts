...
import { ActionListItemDescriptor, IconableAction, DisableableAction, BadgeAction, LoadableAction, DestructableAction } from '../../types';
...
export interface PrimaryActionProps extends DisableableAction, LoadableAction, DestructableAction {
