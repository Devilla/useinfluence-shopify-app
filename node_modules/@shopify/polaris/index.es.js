...
var StickyManager = function () {
    ...
    _createClass(StickyManager, [{
        ...
        value: function manageStickyItems() {
            ...
            var containerTop = getRectForNode(this.container).top;
...
function Avatar$1(_ref) {
    ...
    var className = classNames(styles$1.Avatar, styles$1[variationName('style', styleClass(nameString))], size && styles$1[variationName('size', size)], finalSource && styles$1.hasImage);
...
var Card$1 = function (_React$PureComponent) {
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            var headerMarkup = title ? createElement(Header$1, { actions: actions, title: title }) : null;
...
function TextStyle$1(_ref) {
    ...
    var className = classNames(variation && styles$12[variationName('variation', variation)], variation === Variations.Code && styles$12.code);
...
function Item$6(_ref) {
  ...
  var className = classNames$1(styles$16.Item, disabled && styles$16.disabled, destructive && styles$16.destructive);
...
function Section$3(_ref) {
    ...
    var actionMarkup = section.items.map(function (_a, index) {
        ...
        return createElement(Item$6, Object.assign({ key: content + '-' + index, content: content, onAction: handleAction(onAction) }, item));
    });
    var className = section.title ? null : styles$16['Section-withoutTitle'];
...
var Banner$1 = function (_React$PureComponent) {
    ...
    _createClass(Banner, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$17.Banner, status && styles$17[variationName('status', status)], onDismiss && styles$17.hasDismiss, withinContentContainer ? styles$17.withinContentContainer : styles$17.withinPage);
            var id = uniqueID();
...
function TextContainer$1(_ref) {
    ...
    var className = classNames(styles$18.TextContainer, spacing && styles$18[variationName('spacing', spacing)]);
    return createElement(
        'div',
        { className: className },
        children
...
function Choice$1(_ref) {
  ...
  var className = classNames(styles$22.Choice, labelHidden && styles$22.labelHidden, disabled && styles$22.disabled);
...
function Checkbox$1(_ref) {
    ...
    var wrapperClassName = classNames(styles$23.Checkbox, error && styles$23.error);
    ...
    var inputClassName = classNames(styles$23.Input, isIndeterminate && styles$23['Input-indeterminate']);
    return (
...
function ChoiceList$1(_ref) {
    ...
    var className = classNames(styles$25.ChoiceList, titleHidden && styles$25.titleHidden);
    ...
    var choicesMarkup = choices.map(function (choice) {
        ...
        var children = choice.renderChildren ? createElement(
            'div',
...
var Collapsible$1 = function (_React$Component) {
    ...
    _createClass(Collapsible, [{
        ...
        value: function render() {
            ...
            var wrapperClassName = classNames(styles$26.Collapsible, open && styles$26.open, animating && styles$26.animating);
    ...
    _createClass(AlphaPicker, [{
        ...
        value: function render() {
            ...
            return createElement(
                ...
                createElement('div', { className: styles$27.ColorLayer, style: { background: background } }),
...
var Item$8 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$28.Item, focused && styles$28['Item-focused'], position === ItemPosition.Primary ? styles$28['Item-primary'] : styles$28['Item-connection']);
            return createElement(
                'div',
...
function Cell$1(_ref) {
  ...
  var className = classNames(styles$29.Cell, fixed && styles$29['Cell-fixed'], fixed && truncate && styles$29['Cell-truncated'], header && styles$29['Cell-header'], total && styles$29['Cell-total'], footer && styles$29['Cell-footer'], numeric && styles$29['Cell-numeric'], sortable && styles$29['Cell-sortable'], sorted && styles$29['Cell-sorted']);
  var headerClassName = classNames(header && styles$29.Heading, header && contentType === 'text' && styles$29['Heading-left']);
  var iconClassName = classNames(sortable && styles$29.Icon);
  var style = {
...
function Navigation$1(_ref) {
    ...
    var pipMarkup = columnVisibilityData.map(function (column, index) {
        var className = classNames(styles$29.Pip, column.isVisible && styles$29['Pip-visible']);
...
var DataTable$1 = function (_React$PureComponent) {
    ...
    function DataTable(props) {
        ...
        _this.state = {
            ...
            sorted: _this.props.sortable && _this.props.sortable.length > 0,
            heights: [],
    ...
    _createClass(DataTable, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$29.DataTable, collapsed && styles$29.collapsed, footerContent && styles$29.hasFooter);
            var wrapperClassName = classNames(styles$29.TableWrapper, collapsed && styles$29.collapsed);
            var footerClassName = classNames(footerContent && styles$29.TableFoot);
        ...
        key: 'setDataTable',
        value: function setDataTable(dataTable) {
            this.dataTable = dataTable;
        }
    }, {
        key: 'setScrollContainer',
        value: function setScrollContainer(scrollContainer) {
        ...
        value: function handleResize() {
            ...
            var collapsed = this.table.scrollWidth > this.scrollContainer.clientWidth;
        ...
        value: function calculateColumnVisibilityData(collapsed) {
            if (collapsed) {
                var headerCells = this.table.querySelectorAll('[class*=header]');
                ...
                var tableLeftVisibleEdge = this.scrollContainer.scrollLeft + fixedColumnWidth;
                var tableRightVisibleEdge = this.scrollContainer.scrollLeft + this.dataTable.offsetWidth;
                var tableData = {
        ...
        value: function navigateTable(direction) {
            ...
            var handleScroll = function handleScroll() {
                ...
                _this5.scrollContainer.scrollLeft = direction === 'right' ? currentColumn.rightEdge - fixedColumnWidth : previousColumn.leftEdge - fixedColumnWidth;
                requestAnimationFrame(function () {
                    _this5.setState(Object.assign({}, _this5.calculateColumnVisibilityData(_this5.state.collapsed)));
                });
            };
            return handleScroll;
        }
        ...
        value: function defaultRenderRow(row, index) {
            var className = classNames(styles$29.TableRow);
            var _props4 = this.props,
                    ...
                    if (onSort) {
                        ...
                        if (!truncate) {
                            var preservedScrollPosition = {
                                left: _this6.scrollContainer.scrollLeft,
                                top: window.scrollY
                            };
                            _this6.setState({ preservedScrollPosition: preservedScrollPosition });
                            _this6.handleResize();
                        }
                    }
                });
...
var Day$1 = function (_React$PureComponent) {
    ...
    _createClass(Day, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$30.Day, selected && styles$30['Day-selected'], disabled && styles$30['Day-disabled'], today && styles$30['Day-today'], (inRange || inHoveringRange) && !disabled && styles$30['Day-inRange']);
...
function Weekday$1(_ref) {
    ...
    var className = classNames(styles$30.Weekday, current && styles$30['Weekday-current']);
    return createElement(
        'div',
...
function Month$1(_ref) {
    ...
    var className = classNames(styles$30.Title, current && styles$30['Month-current']);
...
function DisplayText$1(_ref) {
    ...
    var className = classNames(styles$32.DisplayText, size && styles$32[variationName('size', size)]);
    return createElement(
        Element,
        { className: className },
        children
...
function Label$1(_ref) {
    ...
    var className = classNames(styles$33.Label, hidden && styles$33.hidden);
    return createElement(
        'div',
        { className: className },
        createElement(
...
function Labelled$1(_a) {
  ...
  var className = classNames(labelHidden && styles$34.hidden);
...
var FileUpload$1 = function (_React$Component) {
    ...
    _createClass(FileUpload, [{
        ...
        value: function render() {
            ...
            var imageClasses = classNames(styles$36.Image, size && size === 'extraLarge' && styles$36.sizeExtraLarge, size && size === 'large' && styles$36.sizeLarge);
...
var getUniqueID$3 = createUniqueIDFactory('DropZone');
var DropZone$1 = function (_React$Component) {
    ...
    _createClass(DropZone, [{
        ...
        value: function render() {
            ...
            var classes = classNames(styles$37.DropZone, outline && styles$37.hasOutline, (active || dragging) && styles$37.isDragging, error && styles$37.hasError, size && size === 'extraLarge' && styles$37.sizeExtraLarge, size && size === 'large' && styles$37.sizeLarge, size && size === 'medium' && styles$37.sizeMedium, size && size === 'small' && styles$37.sizeSmall);
...
var EmptySearchResult$1 = function (_React$PureComponent) {
    ...
    _createClass(EmptySearchResult, [{
        ...
        value: function render() {
            ...
            var illustrationMarkup = withIllustration ? createElement(Image$1, { alt: altText, source: emptySearch, className: styles$38.Image, draggable: false }) : null;
            return createElement(
                Stack$1,
...
var EmptyState$1 = function (_React$PureComponent) {
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$39.EmptyState, imageContained && styles$39.imageContained);
      var imageMarkup = largeImage ? createElement(Image$1, { alt: '', role: 'presentation', className: styles$39.Image, source: largeImage, sourceSet: [{ source: image, descriptor: '568w' }, { source: largeImage, descriptor: '1136w' }], sizes: '(max-width: 568px) 60vw' }) : createElement(Image$1, { role: 'presentation', alt: '', className: styles$39.Image, source: image });
      var secondaryActionMarkup = secondaryAction ? buttonFrom(secondaryAction, { plain: true }) : null;
      return createElement(
        'div',
        { className: className },
...
function ExceptionList$1(_ref) {
  ...
  var items = itemsList.map(function (item, index) {
    ...
    var itemClasses = classNames(styles$41.Item, status && styles$41[variationName('status', status)]);
    var iconMarkup = icon ? createElement(Icon$2, { source: icon }) : createElement('span', { className: styles$41.Bullet });
    var titleMarkup = title && createElement(
      'span',
...
var getUniqueID$4 = createUniqueIDFactory('FormLayoutGroup');
function Group$1(_ref) {
    ...
    var className = classNames(condensed && styles$43.condensed);
...
function Section$5(_ref) {
    ...
    var className = classNames(styles$45.Section, secondary && styles$45['Section-secondary'], fullWidth && styles$45['Section-fullWidth']);
    return createElement(
        'div',
        { className: className },
        children
...
var ContentList = function (_React$PureComponent) {
    ...
    _createClass(ContentList, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$46.List, type && styles$46[variationName('type', type)]);
...
function Dialog$1(_a) {
  ...
  var classes = classNames(styles$47.Modal, large && styles$47.sizeLarge, limitHeight && styles$47.limitHeight);
...
function Footer$1(_ref) {
  ...
  var actions = primaryActionButton || secondaryActionButtons ? createElement(
    ButtonGroup$1,
    null,
...
var styles$49 = {
  ...
  "withoutTitle": "Polaris-Modal-Header--withoutTitle",
  "CloseButton": "Polaris-Modal-Header__CloseButton",
...
function CloseButton(_ref) {
    ...
    var className = classNames$1(styles$49.CloseButton, !title && styles$49.withoutTitle);
    return createElement(
        'button',
...
Modal$3.contextTypes = { easdk: object };
Modal$3.childContextTypes = contentContextTypes;
Modal$3.Dialog = Dialog$1;
Modal$3.Section = Section$7;
__decorate([autobind], Modal$3.prototype, "handleEntered", null);
__decorate([autobind], Modal$3.prototype, "handleExited", null);
__decorate([autobind], Modal$3.prototype, "handleIFrameLoad", null);
...
var Option$1 = function (_React$Component) {
    ...
    _createClass(Option, [{
        ...
        value: function render() {
            ...
            var singleSelectClassName = classNames(styles$52.SingleSelectOption, focused && styles$52.focused, disabled && styles$52.disabled, select && styles$52.select, active && styles$52.active);
            var multiSelectClassName = classNames(styles$52.Label, active && styles$52.active);
...
var getUniqueID$6 = createUniqueIDFactory('Checkbox');
function Checkbox$4(_ref) {
  ...
  var className = classNames(styles$53.Checkbox, active && styles$53.active);
  return createElement(
    'div',
    { className: className },
        ...
        value: function render() {
            ...
            var optionsMarkup = optionsExist ? normalizedOptions.map(function (_ref2, sectionIndex) {
                ...
                return createElement(
                    ...
                    createElement(
                        'ul',
                        { className: styles$54.Options, id: _this2.id, role: role, 'aria-multiselectable': allowMultiple },
                        optionsMarkup
                    )
                );
            }) : null;
...
var styles$55 = {
  ...
  "Title-hidden": "Polaris-Page__Title--hidden",
  ...
  "withActions": "Polaris-Page--withActions",
  "Action-outline": "Polaris-Page__Action--outline",
};

function Action$1(_ref) {
  var icon = _ref.icon,
      url = _ref.url,
      external = _ref.external,
      onAction = _ref.onAction,
  ...
  var indicatorMarkup = false && showIndicator && !hasIndicator && createElement(Indicator$1, null);
  var className = classNames$1(styles$55.Action, disabled && styles$55.disabled, icon && children == null && styles$55.iconOnly, false && showIndicator && styles$55['Action-outline']);
  return createElement(
    'button',
...
var getUniqueID$8 = createUniqueIDFactory('portal-');
...
var Scrollable$1 = function (_React$Component) {
    ...
    _createClass(Scrollable, [{
        ...
        value: function render() {
            ...
            var finalClassName = classNames(className, styles$57.Scrollable, vertical && styles$57.vertical, horizontal && styles$57.horizontal, topShadow && styles$57.hasTopShadow, bottomShadow && styles$57.hasBottomShadow);
            return createElement(
                'div',
...
var PositionedOverlay$1 = function (_React$PureComponent) {
    ...
    _createClass(PositionedOverlay, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$58.PositionedOverlay, fixed && styles$58.fixed);
            return createElement(
                'div',
...
var TooltipOverlay$1 = function (_React$PureComponent) {
    ...
    _createClass(TooltipOverlay, [{
        ...
        value: function renderTooltip(overlayDetails) {
            ...
            var containerClassName = classNames(styles$59.Tooltip, light && styles$59.light, measuring && styles$59.measuring, positioning === 'above' && styles$59.positionedAbove);
            var contentStyles = measuring ? undefined : { maxHeight: desiredHeight };
            var tipMarkup = !measuring ? createElement('div', { style: tipStyle, className: styles$59.Tip }) : null;
            return createElement(
                'div',
...
var getUniqueID$7 = createUniqueIDFactory('TooltipContent');
...
function Pagination$1(_ref) {
    ...
    var className = classNames$1(styles$60.Pagination, plain && styles$60.plain);
    ...
    var previousButtonEvents = previousKeys && (previousURL || onPrevious) && previousKeys.map(function (key) {
        return createElement(KeypressListener$1, { key: key, keyCode: key, handler: previousURL ? clickPaginationLink('previousURL') : onPrevious });
    });
    var nextButtonEvents = nextKeys && (nextURL || onNext) && nextKeys.map(function (key) {
        return createElement(KeypressListener$1, { key: key, keyCode: key, handler: nextURL ? clickPaginationLink('nextURL') : onNext });
    });
    return createElement(
        'nav',
...
function Pane$1(_ref) {
    ...
    var className = classNames(styles$61.Pane, fixed && styles$61['Pane-fixed']);
    var content = sectioned ? wrapWithComponent(children, Section$9) : children;
...
var PopoverOverlay$1 = function (_React$PureComponent) {
    ...
    _createClass(PopoverOverlay, [{
        ...
        value: function renderPopover(transitionStatus, overlayDetails) {
            ...
            var className = classNames(styles$61.Popover, transitionStatus && animationVariations(transitionStatus), positioning === 'above' && styles$61.positionedAbove, fullWidth && styles$61.fullWidth, measuring && styles$61.measuring);
            this.transitionStatus = transitionStatus;
            var tipMarkup = !measuring ? createElement('div', { style: { left: activatorRect.center.x - left }, className: styles$61.Tip }) : null;
            var contentStyles = measuring ? undefined : { height: desiredHeight };
            var contentClassNames = classNames(styles$61.Content, fullHeight && styles$61['Content-fullHeight']);
...
var getUniqueID$9 = createUniqueIDFactory('Popover');
...
var Header$5 = function (_React$PureComponent) {
    ...
    _createClass(Header, [{
        ...
        value: function renderSecondaryActions() {
            ...
            var actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(function (_ref) {
                ...
                var detailsClassName = classNames(styles$55.Details, actions && Array.isArray(actions) && actions.length > 0 && styles$55.withActions);
                var detailsMarkup = details ? createElement(
                    'div',
                ...
                var active = title === openActionGroup;
                return createElement(
                    'div',
                    ...
                    createElement(
                        ...
                        { key: title, active: active
                            // eslint-disable-next-line react/jsx-no-bind
                            , onClose: _this2.handleActionGroupClose.bind(_this2, title), activator: createElement(
                                Action$1,
                                { showIndicator: showIndicator, hasIndicator: active, disclosure: true, icon: icon
                                    // eslint-disable-next-line react/jsx-no-bind
                                    , onAction: _this2.handleActionGroupOpen.bind(_this2, title) },
                                title
                            ) },
                        createElement(ActionList$1, { items: actions
                            // eslint-disable-next-line react/jsx-no-bind
                            , onActionAnyItem: _this2.handleActionGroupClose.bind(_this2, title) }),
                        detailsMarkup
                    )
                );
            }) : null;
...
var Page$1 = function (_React$PureComponent) {
    ...
    _createClass(Page, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$55.Page, fullWidth && styles$55.fullWidth, singleColumn && styles$55.singleColumn);
            var headerMarkup = this.props.polaris.easdk || !this.hasHeaderContent() ? null : createElement(Header$5, rest);
            return createElement(
                'div',
                { className: className },
                headerMarkup,
...
var getUniqueID$10 = createUniqueIDFactory('RangeSlider');
...
var RangeSlider$1 = function (_React$PureComponent) {
    ...
    _createClass(RangeSlider, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$63.RangeSlider, error && styles$63.error, disabled && styles$63.disabled);
            return createElement(
                Labelled$1,
...
function Select$1(_ref) {
    var optionsProp = _ref.options,
        ...
        _ref$id = _ref.id,
        id = _ref$id === undefined ? getUniqueID$12() : _ref$id,
        name = _ref.name,
    ...
    var className = classNames(styles$64.Select, error && styles$64.error, disabled && styles$64.disabled);
...
function CheckableButton$1(_ref) {
    ...
    var className = plain ? classNames(styles$65.CheckableButton, styles$65['CheckableButton-plain']) : classNames(styles$65.CheckableButton, selectMode && styles$65['CheckableButton-selectMode'], selected && styles$65['CheckableButton-selected'], measuring && styles$65['CheckableButton-measuring']);
    return createElement(
        'div',
...
var BulkActionButton = function (_React$PureComponent) {
    ...
    _createClass(BulkActionButton, [{
        ...
        value: function render() {
            ...
            var className = classNames$1(styles$66.Button, disabled && styles$66.disabled);
            return createElement(
                'button',
...
var BulkActions$1 = function (_React$PureComponent) {
    ...
    _createClass(BulkActions, [{
        ...
        value: function render() {
            ...
            var cancelButtonClassName = classNames(styles$66.Button, styles$66['Button-cancel']);
            ...
            var promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0 ? [].concat(_toConsumableArray(promotedActions)).slice(0, numberOfPromotedActionsToRender).map(function (action, index) {
                return createElement(BulkActionButton, Object.assign({}, action, { key: index, handleMeasurement: _this2.handleMeasurement }));
            }) : null;
            ...
            var smallScreenGroup = createElement(
                ...
                function (status) {
                    var smallScreenGroupClassName = classNames(styles$66.Group, styles$66['Group-smallScreen'], styles$66['Group-' + status]);
                    return createElement(
                        'div',
            ...
            var largeScreenGroup = createElement(
                ...
                function (status) {
                    var largeScreenGroupClassName = classNames(styles$66.Group, styles$66['Group-largeScreen'], !measuring && styles$66['Group-' + status], measuring && styles$66['Group-measuring']);
                    return createElement(
                        'div',
                        ...
                        createElement(
                            'div',
                            { className: styles$66.ButtonGroup, ref: _this2.setLargeScreenButtonsNode },
                            createElement(CheckableButton$2, checkableButtonProps),
...
var styles$67 = {
  "DateTextField": "Polaris-ResourceList-DateSelector__DateTextField",
  "DatePicker": "Polaris-ResourceList-DateSelector__DatePicker",
};
...
var DateSelector$1 = function (_React$PureComponent) {
    ...
    _createClass(DateSelector, [{
        ...
        value: function render() {
            ...
            var showDatePredicate = dateFilterOption === DateFilterOptions.OnOrBefore || dateFilterOption === DateFilterOptions.OnOrAfter;
...
var FilterValueSelector = function (_React$PureComponent) {
...
var FilterCreator = function (_React$PureComponent) {
    ...
    _createClass(FilterCreator, [{
        ...
        value: function render() {
            ...
            var filterValueSelectionMarkup = selectedFilter ? createElement(FilterValueSelector$1, { filter: selectedFilter, filterKey: selectedFilterKey, value: selectedFilterValue, onFilterKeyChange: this.handleFilterKeyChange, onChange: this.handleFilterValueChange }) : null;
...
var FilterControl$1 = function (_React$Component) {
    ...
    _createClass(FilterControl, [{
        ...
        value: function render() {
            ...
            var filterCreatorMarkup = filters.length > 0 ? createElement(FilterCreator$1, { resourceName: resourceName, filters: filters, onAddFilter: this.handleAddFilter, disabled: selectMode }) : null;
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                accessibilityLabel = _props.accessibilityLabel;
            var _context = this.context,
                selectable = _context.selectable,
                selectMode = _context.selectMode;
            var _state = this.state,
            ...
            var className = classNames(styles$69.Item, focused && styles$69.focused, selectable && styles$69.selectable, selected && styles$69.selected, selectMode && styles$69.selectMode, persistActions && styles$69.persistActions, focusedInner && styles$69.focusedInner);
            ...
            var accessibleMarkup = url ? createElement(UnstyledLink$2, { 'aria-describedby': this.props.id, 'aria-label': accessibilityLabel, className: styles$69.Link, url: url, onFocus: this.handleAnchorFocus, onBlur: this.handleFocusedBlur }) : createElement('button', { className: styles$69.Button, 'aria-label': accessibilityLabel, 'aria-controls': ariaControls, 'aria-expanded': ariaExpanded, onClick: this.handleClick, onFocus: this.handleAnchorFocus, onBlur: this.handleFocusedBlur });
            return createElement(
                'div',
        ...
        value: function handleSelection(value) {
            ...
            var onSelectionChange = this.context.onSelectionChange;
        ...
        value: function handleClick(event) {
            ...
            var selectMode = this.context.selectMode;
...
Item$15.contextTypes = contextTypes$1;
__decorate([autobind], Item$15.prototype, "setNode", null);
__decorate([autobind], Item$15.prototype, "handleAnchorFocus", null);
__decorate([autobind], Item$15.prototype, "handleFocusedBlur", null);
__decorate([autobind], Item$15.prototype, "handleFocus", null);
__decorate([autobind], Item$15.prototype, "handleBlur", null);
__decorate([autobind], Item$15.prototype, "handleMouseDown", null);
__decorate([autobind], Item$15.prototype, "handleLargerSelectionArea", null);
__decorate([autobind], Item$15.prototype, "handleSelection", null);
__decorate([autobind], Item$15.prototype, "handleClick", null);
__decorate([autobind], Item$15.prototype, "handleKeypress", null);
__decorate([autobind], Item$15.prototype, "handleContextUpdate", null);
__decorate([autobind], Item$15.prototype, "handleActionsClick", null);
__decorate([autobind], Item$15.prototype, "handleCloseRequest", null);
function stopPropagation(event) {
    event.stopPropagation();
}
var Item$16 = withAppProvider()(Item$15);
...
var styles$70 = {
  ...
  "ItemCountTextWrapper": "Polaris-ResourceList__ItemCountTextWrapper",
...
var getUniqueID$11 = createUniqueIDFactory('Select');
    ...
    _createClass(ResourceList, [{
        ...
        value: function getChildContext() {
            var _props = this.props,
                ...
                _props$resourceName = _props.resourceName,
                resourceName = _props$resourceName === undefined ? this.defaultResourceName : _props$resourceName;
        ...
        value: function render() {
            ...
            var _props2 = this.props,
                items = _props2.items,
                promotedBulkActions = _props2.promotedBulkActions,
                bulkActions = _props2.bulkActions,
                filterControl = _props2.filterControl,
                _props2$showHeader = _props2.showHeader,
                showHeader = _props2$showHeader === undefined ? false : _props2$showHeader,
                sortOptions = _props2.sortOptions,
                sortValue = _props2.sortValue,
                onSortChange = _props2.onSortChange,
                intl = _props2.polaris.intl;
            var _state = this.state,
                selectMode = _state.selectMode,
                _state$listNode = _state.listNode,
                listNode = _state$listNode === undefined ? null : _state$listNode;
            ...
            var itemCountTextMarkup = createElement(
                'div',
            ...
            var headerMarkup = (showHeader || needsHeader) && listNode && itemsExist && createElement(
                'div',
                ...
                createElement(
                    ...
                    function (isSticky) {
                        var headerClassName = classNames(styles$70.HeaderWrapper, sortOptions && sortOptions.length > 0 && styles$70['HeaderWrapper-hasSort'], _this2.selectable && styles$70['HeaderWrapper-hasSelect'], _this2.selectable && selectMode && styles$70['HeaderWrapper-inSelectMode'], isSticky && styles$70['HeaderWrapper-isSticky']);
                        return createElement(
                            'div',
            ...
            var emptyStateMarkup = filterControl && !itemsExist ? createElement(
                'div',
        ...
        value: function handleToggleAll() {
            var _props6 = this.props,
                onSelectionChange = _props6.onSelectionChange,
                selectedItems = _props6.selectedItems,
                items = _props6.items,
                _props6$idForItem = _props6.idForItem,
                idForItem = _props6$idForItem === undefined ? defaultIdForItem : _props6$idForItem;
        ...
        get: function get$$1() {
            var _props7 = this.props,
                promotedBulkActions = _props7.promotedBulkActions,
                bulkActions = _props7.bulkActions;
        ...
        get: function get$$1() {
            var _props9 = this.props,
                _props9$resourceName = _props9.resourceName,
                resourceName = _props9$resourceName === undefined ? this.defaultResourceName : _props9$resourceName,
                items = _props9.items,
                intl = _props9.polaris.intl;

            var itemsCount = items.length;
            var resource = itemsCount === 1 ? resourceName.singular : resourceName.plural;
        ...
        get: function get$$1() {
            var _props11 = this.props,
                ...
                _props11$selectedItem = _props11.selectedItems,
                selectedItems = _props11$selectedItem === undefined ? [] : _props11$selectedItem,
        ...
        get: function get$$1() {
            var _props13 = this.props,
                hasMoreItems = _props13.hasMoreItems,
...
var Item$18 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$71.Item);
            return createElement(
                'li',
                { role: 'presentation' },
                createElement(
...
__decorate([autobind], Item$18.prototype, "setFocusedNode", null);
...
var Tab$1 = function (_React$PureComponent) {
    ...
    _createClass(Tab, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$71.Tab, selected && styles$71['Tab-selected']);
            var tabIndex = void 0;
...
var TabMeasurer$1 = function (_React$PureComponent) {
    ...
    _createClass(TabMeasurer, [{
        ...
        value: function render() {
            ...
            var classname = classNames(styles$71.Tabs, styles$71.TabMeasurer);
            return createElement(
                'div',
...
var Tabs$1 = function (_React$PureComponent) {
    ...
    _createClass(Tabs, [{
        ...
        value: function render() {
            ...
            var classname = classNames(styles$71.Tabs, fitted && styles$71.fitted, disclosureActivatorVisible && styles$71.fillSpace);
            var disclosureTabClassName = classNames(styles$71.DisclosureTab, disclosureActivatorVisible && styles$71['DisclosureTab-visible']);
            var activator = createElement(
                'button',
...
function Tag$1(_ref) {
  ...
  var className = classNames$1(disabled && styles$72.disabled, styles$72.Tag);
...
var Resizer$1 = function (_React$PureComponent) {
    ...
    _createClass(Resizer, [{
        ...
        value: function render() {
            ...
            var minimumLinesMarkup = minimumLines ? createElement('div', { ref: this.setMinimumLinesNode, className: styles$73.DummyInput, dangerouslySetInnerHTML: {
...
var getUniqueID$13 = createUniqueIDFactory('TextField');
...
var TextField$1 = function (_React$PureComponent) {
    ...
    _createClass(TextField, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$73.TextField, Boolean(value) && styles$73.hasValue, disabled && styles$73.disabled, readOnly && styles$73.readOnly, error && styles$73.error, multiline && styles$73.multiline, this.state.focus && styles$73.focus);
            ...
            var spinnerMarkup = type === 'number' && !disabled ? createElement(Spinner$4, { onChange: this.handleNumberChange }) : null;
            ...
            var inputClassName = classNames(styles$73.Input, suffix && styles$73['Input-suffixed']);
...
function Thumbnail$1(_ref) {
    ...
    var className = classNames(styles$74.Thumbnail, size && styles$74[variationName('size', size)]);
    return createElement(
        'span',
        { className: className },
...
function SkeletonDisplayText$1(_ref) {
    ...
    var className = classNames(styles$75.DisplayText, size && styles$75[variationName('size', size)]);
...
var SkeletonPage = function (_React$PureComponent) {
    ...
    _createClass(SkeletonPage, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$77.Page, fullWidth && styles$77.fullWidth, singleColumn && styles$77.singleColumn);
            var headerClassName = classNames(styles$77.Header, secondaryActions && styles$77['Header-hasSecondaryActions'], breadcrumbs && styles$77['Header-hasBreadcrumbs']);
            ...
            var breadcrumbMarkup = breadcrumbs ? renderSecondaryActions(1) : null;
            var headerMarkup = !this.props.polaris.easdk ? createElement(
                'div',
                { className: headerClassName },
                breadcrumbMarkup,
                titleMarkup,
...
function renderSecondaryActions(actionCount) {
    ...
    for (var i = 0; i < actionCount; i++) {
        ...
        actions.push(createElement(
            'div',
            { className: styles$77.Action, style: { width: width }, key: i },
...
function ProgressBar$1(_ref) {
    ...
    var className = classNames(styles$78.ProgressBar, size && styles$78[variationName('size', size)]);
