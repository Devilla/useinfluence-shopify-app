...
function Avatar$1({ name, source, initials, customer, size = 'medium', accessibilityLabel, polaris: { intl } }) {
    ...
    const className = styles.classNames(styles$1.Avatar, styles$1[styles.variationName('style', styleClass(nameString))], size && styles$1[styles.variationName('size', size)], finalSource && styles$1.hasImage);
    const imageMarkUp = finalSource ? React.createElement(Image$1, { className: styles$1.Image, source: finalSource, alt: '', role: 'presentation' }) : null;
    // Use `dominant-baseline: central` instead of `dy` when Edge supports it.
    const verticalOffset = '0.35em';
    const initialsMarkup = initials ? React.createElement(
        'span',
...
class UnstyledLink$1 extends React.PureComponent {
    render() {
        const _a = this.props,
              polaris = _a.polaris,
        ...
        if (polaris && polaris.link) {
            ...
            if (LinkComponent) {
                const _b = this.props,
                      polaris = _b.polaris,
                      rest = tslib_1.__rest(_b, ["polaris"]);
                return React.createElement(LinkComponent, Object.assign({}, unstyled.props, rest));
            }
        }
        const target$$1 = external ? '_blank' : undefined;
        const rel = external ? 'noopener noreferrer' : undefined;
        return React.createElement('a', Object.assign({ target: target$$1 }, rest, { href: url, rel: rel }, unstyled.props));
    }
}
var UnstyledLink$2 = withAppProvider()(UnstyledLink$1);
...
var styles$2 = {
  ...
  "colorWhite": "p_et",
  "colorBlack": "p_uf",
  "colorSkyLighter": "p_zc",
  "colorSkyLight": "p_bz",
  "colorSky": "p_xf",
  "colorSkyDark": "p_za",
  "colorInkLightest": "p_l6",
  "colorInkLighter": "p_kg",
  "colorInkLight": "p_we",
  "colorInk": "p_cq",
  "colorBlueLighter": "p_y1",
  "colorBlueLight": "p_hv",
  "colorBlue": "p_c0",
  "colorBlueDark": "p_n6",
  "colorBlueDarker": "p_e9",
  "colorIndigoLighter": "p_sf",
  "colorIndigoLight": "p_rj",
  "colorIndigo": "p_gh",
  "colorIndigoDark": "p_r7",
  "colorIndigoDarker": "p_n1",
  "colorTealLighter": "p_el",
  "colorTealLight": "p_u1",
  "colorTeal": "p_tn",
  "colorTealDark": "p_z8",
  "colorTealDarker": "p_tc",
  "colorGreenLighter": "p_h3",
  "colorGreen": "p_j0",
  "colorGreenDark": "p_a7",
  "colorYellowLighter": "p_cs",
  "colorYellow": "p_o4",
  "colorYellowDark": "p_km",
  "colorOrange": "p_q5",
  "colorOrangeDark": "p_hm",
  "colorRedLighter": "p_zj",
  "colorRed": "p_mt",
  "colorRedDark": "p_h8",
  "colorPurple": "p_qu",
  "Svg": "p_vu",
...
function Icon$1({ source, color, backdrop, accessibilityLabel, polaris: { intl } }) {
    ...
    const className = styles.classNames(styles$2.Icon, color && styles$2[styles.variationName('color', color)], color && color !== 'white' && styles$2.isColored, backdrop && styles$2.hasBackdrop);
    let contentMarkup;
...
function Spinner$1({ size = 'large', color = 'teal', accessibilityLabel, polaris: { intl } }) {
    ...
    const className = styles.classNames(styles$3.Spinner, color && styles$3[styles.variationName('color', color)], size && styles$3[styles.variationName('size', size)]);
...
function Indicator$1({ pulse = true }) {
    const className = styles.classNames(styles$4.Indicator, pulse && styles$4.pulseIndicator);
...
function Button$1({ id, url, disabled, loading, children, accessibilityLabel, ariaControls, ariaExpanded, onClick, onFocus, onBlur, external, icon, primary, outline, destructive, disclosure, plain, submit, size, fullWidth, polaris: { intl } }) {
  const indicator = false;
  const isDisabled = disabled || loading;
  const className = reactUtilities.classNames(styles$5.Button, primary && styles$5.primary, outline && styles$5.outline, destructive && styles$5.destructive, isDisabled && styles$5.disabled, loading && styles$5.loading, plain && styles$5.plain, size && styles$5[reactUtilities.variationName('size', size)], fullWidth && styles$5.fullWidth, icon && children == null && styles$5.iconOnly);
  const disclosureIconMarkup = disclosure ? React.createElement(
    'span',
    { className: styles$5.Icon },
    React.createElement(Icon$2, { source: loading ? 'placeholder' : 'caretDown' })
  ) : null;
  const iconMarkup = icon ? React.createElement(
    'span',
    { className: styles$5.Icon },
    React.createElement(Icon$2, { source: loading ? 'placeholder' : icon })
  ) : null;
  const childMarkup = children ? React.createElement(
    'span',
    null,
    children
  ) : null;
  const spinnerColor = primary || destructive ? 'white' : 'inkLightest';
  const spinnerSVGMarkup = loading ? React.createElement(
    'span',
  ...
  const indicatorMarkup = indicator && React.createElement(Indicator$1, null);
  const content = iconMarkup || disclosureIconMarkup ? React.createElement(
    'span',
...
class Item$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
    ...
    render() {
        ...
        const className = styles.classNames(styles$6.Item, focused && styles$6['Item-focused'], button.props.plain && styles$6['Item-plain']);
        return React.createElement(
            'div',
...
function ButtonGroup$1({ children, segmented, fullWidth, connectedTop }) {
    const className = styles.classNames(styles$6.ButtonGroup, segmented && styles$6.segmented, fullWidth && styles$6.fullWidth, connectedTop && styles$6.connectedTop);
    const contents = reactUtilities.elementChildren(children).map((child, index) => React.createElement(Item$1, { button: child, key: index }));
    return React.createElement(
        'div',
        { className: className },
        contents
...
var styles$7 = {
  ...
  "vertical": "p_lv",
  "spacingNone": "p_fm",
  "spacingExtraTight": "p_lw",
  "spacingTight": "p_n3",
  "spacingLoose": "p_y3",
  "spacingExtraLoose": "p_si",
  "distributionLeading": "p_mg",
  "distributionTrailing": "p_ke",
  "distributionCenter": "p_s9",
  "distributionEqualSpacing": "p_gj",
  "distributionFill": "p_o6",
  "distributionFillEvenly": "p_ue",
  "alignmentLeading": "p_oi",
  "alignmentTrailing": "p_vw",
  "alignmentCenter": "p_b4",
  "alignmentFill": "p_ni",
  "alignmentBaseline": "p_bp",
  "Item-fill": "p_f5",
};

function Item$3({ children, fill }) {
    const className = styles.classNames(styles$7.Item, fill && styles$7['Item-fill']);
    return React.createElement(
        'div',
        { className: className },
        children
...
class Stack$1 extends React.PureComponent {
    render() {
        ...
        const className = styles.classNames(styles$7.Stack, vertical && styles$7.vertical, spacing && styles$7[styles.variationName('spacing', spacing)], distribution && styles$7[styles.variationName('distribution', distribution)], alignment && styles$7[styles.variationName('alignment', alignment)], wrap === false && styles$7.noWrap);
        const itemMarkup = reactUtilities.elementChildren(children).map((child, index) => {
            const props = { key: index };
            return reactUtilities.wrapWithComponent(child, Item$3, props);
        });
        return React.createElement(
            'div',
            { className: className },
...
var styles$9 = {
  ...
  "Header": "p_g3",
  "Section": "p_jw",
  "Section-fullWidth": "p_c1",
  "Section-subdued": "p_ri",
  "SectionHeader": "p_l1",
  "Footer": "p_y6",
};

function Header$1({ children, title, actions }) {
    const actionMarkup = actions ? React.createElement(
        ButtonGroup$1,
        null,
        buttonsFrom(actions, { plain: true })
    ) : null;
    const titleMarkup = React.isValidElement(title) ? title : React.createElement(
        Heading$1,
        null,
        title
    );
    const headingMarkup = actionMarkup || children ? React.createElement(
        Stack$1,
        { alignment: 'baseline' },
        React.createElement(
            Stack$1.Item,
...
function Section$1({ children, title, subdued, fullWidth }) {
  const headerContent = title ? React.createElement(
    'div',
  ...
  const className = styles.classNames(styles$9.Section, subdued && styles$9['Section-subdued'], fullWidth && styles$9['Section-fullWidth']);
  return React.createElement(
    'div',
    { className: className },
    headerContent,
...
class Card$1 extends React.PureComponent {
    getChildContext() {
        return {
    ...
    render() {
        ...
        const className = styles.classNames(styles$9.Card, subdued && styles$9.subdued);
        const headerMarkup = title ? React.createElement(Header$1, { actions: actions, title: title }) : null;
        const content = sectioned ? React.createElement(
            Section$1,
            null,
            children
        ) : children;
        ...
        const footerMarkup = primaryFooterActionMarkup || secondaryFooterActionMarkup ? React.createElement(
            'div',
...
function SettingAction$1({ action, children }) {
  return React.createElement(
    'div',
    { className: styles$11.SettingAction },
    React.createElement(
      'div',
      { className: styles$11.Setting },
      children
    ),
    React.createElement(
      'div',
      { className: styles$11.Action },
      action
    )
  );
}
...
var styles$12 = {
  "variationPositive": "p_l9",
  "variationNegative": "p_dq",
  "variationCode": "p_zw",
  "variationStrong": "p_ji",
  "variationSubdued": "p_rf",
};

var Variations;
(function (Variations) {
    Variations["Positive"] = "positive";
    Variations["Negative"] = "negative";
    Variations["Strong"] = "strong";
    Variations["Subdued"] = "subdued";
    Variations["Code"] = "code";
})(Variations || (Variations = {}));
function TextStyle$1({ variation, children }) {
    const className = styles.classNames(variation && styles$12[styles.variationName('variation', variation)], variation === Variations.Code && styles$12.code);
...
function AccountConnection$1({ connected = false, action, avatarUrl, accountName = '', title, details, termsOfService }) {
    ...
    const avatarMarkup = connected ? React.createElement(Avatar$2, { accessibilityLabel: '', name: accountName, initials: initials, source: avatarUrl }) : null;
    ...
    const detailsMarkup = details ? React.createElement(
        'div',
        null,
        React.createElement(
            TextStyle$1,
    ...
    const termsOfServiceMarkup = termsOfService ? React.createElement(
        'div',
...
var styles$15 = {
  ...
  "statusSuccess": "p_qh",
  "statusInfo": "p_in",
  "statusAttention": "p_bn",
  "statusWarning": "p_gb",
  "statusNew": "p_xz",
  "progressIncomplete": "p_at",
  "progressPartiallyComplete": "p_da",
  "progressComplete": "p_gl",
};
...
function Badge$1({ children, status, progress, polaris: { intl } }) {
    const className = styles.classNames(styles$15.Badge, status && styles$15[styles.variationName('status', status)], progress && styles$15[styles.variationName('progress', progress)]);
    let progressMarkup;
    switch (progress) {
    ...
    const pipMarkup = progress ? React.createElement(
        'span',
    ...
    const statusLabelMarkup = status ? React.createElement(
        VisuallyHidden$1,
        null,
        statusMarkup
    ) : null;
...
function Item$5({ badge, content, url, onAction, icon, image, disabled, external, destructive, ellipsis }) {
  const className = reactUtilities.classNames(styles$16.Item, disabled && styles$16.disabled, destructive && styles$16.destructive);
  ...
  if (icon) {
    ...
    imageElement = React.createElement('div', { role: 'presentation', className: styles$16.Image, style: { backgroundImage: `url(${image}` } });
  }
  const contentMarkup = ellipsis && content ? `${content}…` : content;
  const badgeMarkup = badge && React.createElement(
    'span',
    { className: styles$16.BadgeWrapper },
    React.createElement(
      Badge$2,
      { status: badge.status },
      badge.content
  ...
  const textMarkup = imageElement ? React.createElement(
    'div',
  ...
  const control = url ? React.createElement(
    UnstyledLink$2,
    { url: url, onClick: onAction, className: styles$16.Item, external: external },
    contentElement
  ) : React.createElement(
    'button',
    { onClick: onAction, className: className, disabled: disabled, type: 'button' },
    contentElement
  );
  return React.createElement(
    'li',
...
function Section$3({ section, hasMultipleSections, onActionAnyItem }) {
    ...
    const actionMarkup = section.items.map((_a, index) => {
        ...
        return React.createElement(Item$5, Object.assign({ key: `${content}-${index}`, content: content, onAction: handleAction(onAction) }, item));
    });
    const className = section.title ? null : styles$16['Section-withoutTitle'];
    const titleMarkup = section.title ? React.createElement(
        'p',
        { className: styles$16.Title },
        section.title
    ) : null;
    const sectionMarkup = React.createElement(
        'div',
        { className: className },
        titleMarkup,
        React.createElement(
...
function ActionList$1({ items, sections = [], onActionAnyItem }) {
    ...
    const sectionMarkup = finalSections.map((section, index) => {
        return React.createElement(Section$3, { key: section.title || index, section: section, onActionAnyItem: onActionAnyItem, hasMultipleSections: hasMultipleSections });
    });
    return React.createElement(
        Element,
        { className: styles$16.ActionList },
        sectionMarkup
    );
}
...
class Banner$1 extends React.PureComponent {
    render() {
        var _props = this.props;
        ...
        const withinContentContainer = this.context.withinContentContainer;
        ...
        const className = styles.classNames(styles$17.Banner, status && styles$17[styles.variationName('status', status)], onDismiss && styles$17.hasDismiss, withinContentContainer ? styles$17.withinContentContainer : styles$17.withinPage);
        const id = uniqueID();
        ...
        if (title) {
            ...
            headingMarkup = React.createElement(
                'div',
                { className: styles$17.Heading, id: headingID },
                React.createElement(
                    Heading$1,
                    { element: 'p' },
                    title
        ...
        const actionMarkup = action ? React.createElement(
            'div',
            { className: styles$17.Actions },
            React.createElement(
                ButtonGroup$1,
                null,
        ...
        if (children || actionMarkup) {
            ...
            contentMarkup = React.createElement(
                'div',
                { className: styles$17.Content, id: contentID },
                children,
                actionMarkup
            );
        }
        const dismissButton = onDismiss ? React.createElement(
            'div',
            { className: styles$17.Dismiss },
            React.createElement(Button$2, { plain: true, icon: 'cancelSmall', onClick: onDismiss, accessibilityLabel: 'Dismiss notification' })
        ) : null;
        return React.createElement(
            'div',
            { className: className
...
function secondaryActionFrom(action) {
    if (action.url) {
        return React.createElement(
            UnstyledLink$2,
            { className: styles$17.SecondaryAction, url: action.url, external: action.external },
            React.createElement(
                'span',
    ...
    return React.createElement(
        'button',
        { className: styles$17.SecondaryAction, onClick: action.onAction },
        React.createElement(
            'span',
            { className: styles$17.Text },
            action.content
...
function TextContainer$1({ spacing, children }) {
    const className = styles.classNames(styles$18.TextContainer, spacing && styles$18[styles.variationName('spacing', spacing)]);
    return React.createElement(
        'div',
        { className: className },
        children
...
function CalloutCard$1({ title, children, illustration, primaryAction, secondaryAction }) {
  ...
  const buttonMarkup = secondaryActionMarkup ? React.createElement(
    ButtonGroup$1,
    null,
    primaryActionMarkup,
    secondaryActionMarkup
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      { className: styles$19.CalloutCard },
      React.createElement(
        'div',
        { className: styles$19.Content },
        React.createElement(
          'div',
          { className: styles$19.Title },
          React.createElement(
            Heading$1,
            null,
            title
        ...
        React.createElement(
          'div',
          { className: styles$19.Buttons },
          buttonMarkup
        )
      ),
      React.createElement(Image$1, { alt: '', className: styles$19.Image, source: illustration })
    )
  );
}
...
function InlineError$1({ message, fieldID }) {
  if (!message) {
    return null;
  }
  return React.createElement(
    'div',
    { id: `${fieldID}Error`, className: styles$21.InlineError },
    React.createElement(
      'div',
...
function Choice$1({ id, label, disabled, error, children, labelHidden, helpText }) {
  const className = styles.classNames(styles$22.Choice, labelHidden && styles$22.labelHidden, disabled && styles$22.disabled);
  const labelMarkup = React.createElement(
    'label',
    { className: className, htmlFor: id },
    React.createElement(
      'span',
      { className: styles$22.Control },
      children
    ),
    React.createElement(
      'span',
      { className: styles$22.Label },
      label
    )
  );
  const helpTextMarkup = helpText ? React.createElement(
    'div',
    { className: styles$22.HelpText, id: helpTextID(id) },
    helpText
  ) : null;
  const errorMarkup = error && typeof error !== 'boolean' && React.createElement(
    'div',
    { className: styles$22.Error },
    React.createElement(InlineError$1, { message: error, fieldID: id })
  );
  const descriptionMarkup = helpTextMarkup || errorMarkup ? React.createElement(
    'div',
    { className: styles$22.Descriptions },
    errorMarkup,
    helpTextMarkup
  ) : null;
...
var styles$23 = {
  ...
  "Input": "p_pv",
  "Backdrop": "p_ef",
  "Input-indeterminate": "p_n2",
  "Icon": "p_df",
};

const getUniqueID = other.createUniqueIDFactory('Checkbox');
function Checkbox$1({ id = getUniqueID(), label, labelHidden, helpText, checked = false, error, disabled, onChange, onFocus, onBlur, name, value }) {
    ...
    const wrapperClassName = styles.classNames(styles$23.Checkbox, error && styles$23.error);
    ...
    const inputClassName = styles.classNames(styles$23.Input, isIndeterminate && styles$23['Input-indeterminate']);
    return (
        ...
        React.createElement(
            ...
            React.createElement(
                ...
                React.createElement('span', { className: styles$23.Backdrop }),
                React.createElement(
                    'span',
                    { className: styles$23.Icon },
...
const getUniqueID$2 = other.createUniqueIDFactory('RadioButton');
function RadioButton$1({ label, labelHidden, helpText, checked, disabled, onChange, onFocus, onBlur, id = getUniqueID$2(), name = id, value }) {
    ...
    return React.createElement(
        ...
        React.createElement(
            'span',
            { className: styles$24.RadioButton },
            React.createElement('input', { id: id, name: name, value: value, type: 'radio', checked: checked, disabled: disabled, className: styles$24.Input, onChange: handleChange, onFocus: onFocus, onBlur: onBlur, 'aria-describedby': describedBy }),
            React.createElement('span', { className: styles$24.Backdrop }),
            React.createElement('span', { className: styles$24.Icon })
        )
    );
}
...
const getUniqueID$1 = other.createUniqueIDFactory('ChoiceList');
function ChoiceList$1({ title, titleHidden, allowMultiple, choices, selected, onChange = other.noop, error, name = getUniqueID$1() }) {
    const ControlComponent = allowMultiple ? Checkbox$2 : RadioButton$1;
    const finalName = allowMultiple ? `${name}[]` : name;
    const className = styles.classNames(styles$25.ChoiceList, titleHidden && styles$25.titleHidden);
    const titleMarkup = title ? React.createElement(
        'legend',
        { className: styles$25.Title },
        title
    ) : null;
    const choicesMarkup = choices.map(choice => {
        ...
        const children = choice.renderChildren ? React.createElement(
            'div',
            { className: styles$25.ChoiceChildren },
    ...
    const errorMarkup = error && React.createElement(
        'div',
        { className: styles$25.ChoiceChildren },
...
class Collapsible$1 extends React.Component {
    constructor() {
        super(...arguments);
        this.state = {
            height: null,
    ...
    getChildContext() {
        ...
        const parentCollapsibleExpanding = this.context.parentCollapsibleExpanding;
    ...
    render() {
        ...
        const animationState = _state.animationState,
              height = _state.height;

        const animating = animationState !== 'idle';
        const wrapperClassName = styles.classNames(styles$26.Collapsible, open && styles$26.open, animating && styles$26.animating);
...
function hsbToRgb(color) {
    ...
    var _color$alpha = color.alpha;
    const alpha = _color$alpha === undefined ? 1 : _color$alpha;
...
function rgbToHsb(color) {
    const red = color.red,
          green = color.green,
          blue = color.blue;
    var _color$alpha2 = color.alpha;
    const alpha = _color$alpha2 === undefined ? 1 : _color$alpha2;
...
class EventListener$1 extends React.PureComponent {
    componentDidMount() {
        this.attachListener();
    }
    componentWillUpdate() {
    ...
    attachListener() {
        ...
        events.addEventListener(window, event, handler, { capture, passive });
    }
    detachListener() {
...
class Slidable$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
            dragging: false
    ...
    componentDidMount() {
        const onDraggerHeight = this.props.onDraggerHeight;

        if (onDraggerHeight == null) {
            return;
        }
        const draggerNode = this.draggerNode;
    ...
    render() {
        ...
        const draggerX = _props$draggerX === undefined ? 0 : _props$draggerX;
        var _props$draggerY = _props.draggerY;
        const draggerY = _props$draggerY === undefined ? 0 : _props$draggerY;

        const draggerPositioning = {
            transform: `translate3d(${draggerX}px, ${draggerY}px, 0)`
        };
        const moveListener = dragging ? React.createElement(EventListener$1, { event: 'mousemove', handler: this.handleMove }) : null;
        const touchMoveListener = dragging ? React.createElement(EventListener$1, { event: 'touchmove', handler: this.handleMove }) : null;
        const endDragListener = dragging ? React.createElement(EventListener$1, { event: 'mouseup', handler: this.handleDragEnd }) : null;
        const touchEndListener = dragging ? React.createElement(EventListener$1, { event: 'touchend', handler: this.handleDragEnd }) : null;
        const touchCancelListener = dragging ? React.createElement(EventListener$1, { event: 'touchcancel', handler: this.handleDragEnd }) : null;
        return React.createElement(
            'div',
            { ref: this.setNode, className: styles$27.Slidable, onMouseDown: this.startDrag, onTouchStart: this.startDrag },
            endDragListener,
            moveListener,
            touchMoveListener,
            touchEndListener,
            touchCancelListener,
            React.createElement('div', { style: draggerPositioning, className: styles$27.Dragger, ref: this.setDraggerNode })
        );
    }
    setDraggerNode(node) {
...
class AlphaPicker$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
            dragging: false,
    ...
    render() {
        ...
        const color = _props.color,
              alpha = _props.alpha;
        var _state = this.state;
        const sliderHeight = _state.sliderHeight,
              draggerHeight = _state.draggerHeight;

        const offset = offsetForAlpha(alpha, sliderHeight, draggerHeight);
        const draggerY = math.clamp(offset, 0, sliderHeight);
        const background = alphaGradientForColor(color);
        return React.createElement(
            'div',
            { className: styles$27.AlphaPicker, ref: this.setSliderHeight },
            React.createElement('div', { className: styles$27.ColorLayer, style: { background } }),
    ...
    handleChange({ y }) {
        ...
        const offsetY = math.clamp(y, 0, sliderHeight);
...
class HuePicker$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
            dragging: false,
    ...
    render() {
        ...
        return React.createElement(
            'div',
            { className: styles$27.HuePicker, ref: this.setSliderHeight },
            React.createElement(Slidable$1, { draggerY: draggerY, draggerX: 0, onChange: this.handleChange, onDraggerHeight: this.setDraggerHeight })
        );
    }
    setSliderHeight(node) {
...
class ColorPicker$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
            pickerSize: 0
    ...
    render() {
        ...
        var _hsbToRgb = hsbToRgb({ hue, saturation: 1, brightness: 1 });
        ...
        const draggerX = math.clamp(saturation * pickerSize, 0, pickerSize);
        const draggerY = math.clamp(pickerSize - brightness * pickerSize, 0, pickerSize);
        const alphaSliderMarkup = allowAlpha ? React.createElement(AlphaPicker$1, { alpha: alpha, color: color, onChange: this.handleAlphaChange }) : null;
        return React.createElement(
            'div',
            { className: styles$27.ColorPicker, id: id },
            React.createElement(
                'div',
                { ref: this.setColorNode, className: styles$27.MainColor },
                React.createElement('div', { className: styles$27.ColorLayer, style: { backgroundColor: colorString } }),
    ...
    handleHueChange(hue) {
        ...
        const brightness = _props2$color.brightness,
              saturation = _props2$color.saturation;
        var _props2$color$alpha = _props2$color.alpha;
        const alpha = _props2$color$alpha === undefined ? 1 : _props2$color$alpha,
    ...
    handleDraggerMove({ x, y }) {
        ...
        const hue = _props4$color.hue;
        var _props4$color$alpha = _props4$color.alpha;
        const alpha = _props4$color$alpha === undefined ? 1 : _props4$color$alpha,
              onChange = _props4.onChange;

        const saturation = math.clamp(x / pickerSize, 0, 1);
        const brightness = math.clamp(1 - y / pickerSize, 0, 1);
...
class Item$7 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = { focused: false };
    }
    render() {
        ...
        const className = styles.classNames(styles$28.Item, focused && styles$28['Item-focused'], position === ItemPosition.Primary ? styles$28['Item-primary'] : styles$28['Item-connection']);
        return React.createElement(
            'div',
...
function Connected$1({ children, left, right }) {
    ...
    const leftConnectionMarkup = left ? React.createElement(
        Item$7,
        { position: ItemPosition.Left },
        left
    ) : null;
    const rightConnectionMarkup = right ? React.createElement(
        Item$7,
...
function Cell$1({ height, content, contentType, fixed, truncate, header, total, footer, sorted, sortable, sortDirection, defaultSortDirection, polaris: { intl: { translate } }, onSort }) {
  const numeric = contentType === 'numeric';
  const className = styles.classNames(styles$29.Cell, fixed && styles$29['Cell-fixed'], fixed && truncate && styles$29['Cell-truncated'], header && styles$29['Cell-header'], total && styles$29['Cell-total'], footer && styles$29['Cell-footer'], numeric && styles$29['Cell-numeric'], sortable && styles$29['Cell-sortable'], sorted && styles$29['Cell-sorted']);
  const headerClassName = styles.classNames(header && styles$29.Heading, header && contentType === 'text' && styles$29['Heading-left']);
  const iconClassName = styles.classNames(sortable && styles$29.Icon);
  const style = {
  ...
  const sortableHeadingContent = React.createElement(
    'button',
  ...
  const headingMarkup = header ? React.createElement(
    'th',
    { className: className, scope: 'col', 'aria-sort': sortDirection, style: style },
  ...
  const cellMarkup = header || fixed ? headingMarkup : React.createElement(
    'td',
...
function Navigation$1({ columnVisibilityData, isScrolledFarthestLeft, isScrolledFarthestRight, navigateTableLeft, navigateTableRight, polaris: { intl: { translate } } }) {
    const pipMarkup = columnVisibilityData.map((column, index) => {
        const className = styles.classNames(styles$29.Pip, column.isVisible && styles$29['Pip-visible']);
    ...
    return React.createElement(
        'div',
        { className: styles$29.Navigation },
        React.createElement(Button$2, { plain: true, icon: 'chevronLeft', disabled: isScrolledFarthestLeft, accessibilityLabel: leftA11yLabel, onClick: navigateTableLeft }),
        pipMarkup,
        React.createElement(Button$2, { plain: true, icon: 'chevronRight', disabled: isScrolledFarthestRight, accessibilityLabel: rightA11yLabel, onClick: navigateTableRight })
    );
}
var Navigation$2 = withAppProvider()(Navigation$1);

class DataTable$1 extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            collapsed: false,
        ...
        const translate = props.polaris.intl.translate;
    ...
    render() {
        var _props = this.props;
        const columnContentTypes = _props.columnContentTypes,
        ...
        var _props$defaultSortDir = _props.defaultSortDirection;
        const defaultSortDirection = _props$defaultSortDir === undefined ? 'ascending' : _props$defaultSortDir;
        var _props$initialSortCol = _props.initialSortColumnIndex;
        const initialSortColumnIndex = _props$initialSortCol === undefined ? 0 : _props$initialSortCol;
        var _state = this.state;
        const collapsed = _state.collapsed,
              columnVisibilityData = _state.columnVisibilityData,
              heights = _state.heights;
        var _state$sortedColumnIn = _state.sortedColumnIndex;
        const sortedColumnIndex = _state$sortedColumnIn === undefined ? initialSortColumnIndex : _state$sortedColumnIn;
        var _state$sortDirection = _state.sortDirection;
        const sortDirection = _state$sortDirection === undefined ? defaultSortDirection : _state$sortDirection,
              isScrolledFarthestLeft = _state.isScrolledFarthestLeft,
              isScrolledFarthestRight = _state.isScrolledFarthestRight;

        const className = styles.classNames(styles$29.DataTable, collapsed && styles$29.collapsed, footerContent && styles$29.hasFooter);
        const wrapperClassName = styles.classNames(styles$29.TableWrapper, collapsed && styles$29.collapsed);
        const footerClassName = styles.classNames(footerContent && styles$29.TableFoot);
        const footerMarkup = footerContent ? React.createElement(
            'tfoot',
        ...
        const totalsMarkup = totals ? React.createElement(
            'tr',
            null,
            totals.map(this.renderTotals)
        ) : null;
        const headingMarkup = React.createElement(
            'tr',
            null,
        ...
        const style = footerContent ? { marginBottom: `${heights[heights.length - 1]}px` } : undefined;
        return React.createElement(
            'div',
            { className: wrapperClassName },
            ...
            React.createElement(
                'div',
                { className: className, ref: this.setDataTable },
                React.createElement(
                    'div',
                    { className: styles$29.ScrollContainer, ref: this.setScrollContainer, style: style },
                    ...
                    React.createElement(
                        'table',
                        { className: styles$29.Table, ref: this.setTable },
                        React.createElement(
                            'thead',
                            null,
                            headingMarkup,
    ...
    handleResize() {
        var _props2 = this.props;
        const footerContent = _props2.footerContent,
    ...
    tallestCellHeights() {
        var _props3 = this.props;
        const footerContent = _props3.footerContent,
        ...
        if (footerContent) {
            const footerCellHeight = rows[rows.length - 1].childNodes[0].clientHeight;
    ...
    resetScrollPosition() {
        ...
        const left = _state$preservedScrol.left,
    ...
    calculateColumnVisibilityData(collapsed) {
        if (collapsed) {
            const headerCells = this.table.querySelectorAll('[class*=header]');
            ...
            const tableLeftVisibleEdge = this.scrollContainer.scrollLeft + fixedColumnWidth;
            const tableRightVisibleEdge = this.scrollContainer.scrollLeft + this.dataTable.offsetWidth;
            const tableData = {
                fixedColumnWidth,
    ...
    scrollListener() {
        this.setState(Object.assign({}, this.calculateColumnVisibilityData(this.state.collapsed)));
    }
    navigateTable(direction) {
        var _state2 = this.state;
        const currentColumn = _state2.currentColumn,
        ...
        const handleScroll = () => {
            ...
            this.scrollContainer.scrollLeft = direction === 'right' ? currentColumn.rightEdge - fixedColumnWidth : previousColumn.leftEdge - fixedColumnWidth;
    ...
    renderTotals(total, index) {
        ...
        const truncate = _props$truncate === undefined ? false : _props$truncate;
    ...
    defaultRenderRow(row, index) {
        const className = styles.classNames(styles$29.TableRow);
        var _props4 = this.props;
        const columnContentTypes = _props4.columnContentTypes,
              totals = _props4.totals,
              footerContent = _props4.footerContent;
        var _props4$truncate = _props4.truncate;
        const truncate = _props4$truncate === undefined ? false : _props4$truncate;
        const heights = this.state.heights;
    ...
    defaultOnSort(headingIndex) {
        ...
        const onSort = _props5.onSort,
              truncate = _props5.truncate;
        var _props5$defaultSortDi = _props5.defaultSortDirection;
        const defaultSortDirection = _props5$defaultSortDi === undefined ? 'ascending' : _props5$defaultSortDi,
              initialSortColumnIndex = _props5.initialSortColumnIndex;
        var _state3 = this.state;
        const sortDirection = _state3.sortDirection;
        var _state3$sortedColumnI = _state3.sortedColumnIndex;
        const sortedColumnIndex = _state3$sortedColumnI === undefined ? initialSortColumnIndex : _state3$sortedColumnI;
...
tslib_1.__decorate([decorators.autobind], DataTable$1.prototype, "setDataTable", null);
tslib_1.__decorate([decorators.autobind], DataTable$1.prototype, "setScrollContainer", null);
tslib_1.__decorate([decorators.autobind], DataTable$1.prototype, "setTable", null);
...
function measureColumn(tableData) {
    return function (column, index) {
        const firstVisibleColumnIndex = tableData.firstVisibleColumnIndex,
...
var styles$30 = {
  ...
  "Day-disabled": "p_a2",
  "Weekday": "p_lj",
  "Weekday-current": "p_xd",
  "Header": "p_ob",
  "Title": "p_my",
};

class Day$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.dayNode = null;
    }
    ...
    render() {
        var _props = this.props;
        const day = _props.day,
              focused = _props.focused,
              onClick = _props.onClick;
        var _props$onHover = _props.onHover;
        const onHover = _props$onHover === undefined ? other.noop : _props$onHover;
        var _props$onFocus = _props.onFocus;
        const onFocus = _props$onFocus === undefined ? other.noop : _props$onFocus,
        ...
        if (!day) {
            return React.createElement('div', { className: styles$30.EmptyDay, onMouseOver: handleHover });
        }
        const handleClick = onClick && !disabled ? onClick.bind(null, day) : other.noop;
        const today = dates.isSameDay(new Date(), day);
        const className = styles.classNames(styles$30.Day, selected && styles$30['Day-selected'], disabled && styles$30['Day-disabled'], today && styles$30['Day-today'], (inRange || inHoveringRange) && !disabled && styles$30['Day-inRange']);
        const date = day.getDate();
        const tabIndex = (focused || selected || today || date === 1) && !disabled ? 0 : -1;
        const ariaLabel = [`${today ? intl.translate('Polaris.DatePicker.today') : ''}`, `${dates.Months[day.getMonth()]} `, `${date} `, `${day.getFullYear()}`].join('');
        return React.createElement(
            'button',
            {
                // eslint-disable-next-line react/jsx-no-bind
                onFocus: onFocus.bind(null, day), type: 'button', ref: this.setNode, tabIndex: tabIndex, className: className, onMouseOver: handleHover, onClick: handleClick, 'aria-label': ariaLabel, 'aria-selected': selected, 'aria-disabled': disabled, role: 'gridcell' },
            date
        );
    }
    setNode(node) {
...
function Weekday$1({ label, title, current }) {
    const className = styles.classNames(styles$30.Weekday, current && styles$30['Weekday-current']);
    return React.createElement(
        'div',
...
const WEEKDAYS = [dates.Weekdays.Sunday, dates.Weekdays.Monday, dates.Weekdays.Tuesday, dates.Weekdays.Wednesday, dates.Weekdays.Thursday, dates.Weekdays.Friday, dates.Weekdays.Saturday];
function Month$1({ focusedDate, selected, hoverDate, disableDatesBefore, disableDatesAfter, allowRange, onChange = other.noop, onHover = other.noop, onFocus = other.noop, month, year, weekStartsOn }) {
    const isInHoveringRange = allowRange ? hoveringDateIsInRange : () => false;
    const now = new Date();
    const current = now.getMonth() === month && now.getFullYear() === year;
    const className = styles.classNames(styles$30.Title, current && styles$30['Month-current']);
    const weeks = dates.getWeeksForMonth(month, year, weekStartsOn);
    const weekdays = getWeekdaysOrdered(weekStartsOn).map(weekday => React.createElement(Weekday$1, { key: weekday, title: dates.abbreviationForWeekday(weekday), current: current && new Date().getDay() === weekday, label: weekday }));
    ...
    function renderWeek(day, dayIndex) {
        ...
        const disabled = disableDatesBefore && dates.isDateBefore(day, disableDatesBefore) || disableDatesAfter && dates.isDateAfter(day, disableDatesAfter);
    ...
    const weeksMarkup = weeks.map((week, index) => React.createElement(
        'div',
        { role: 'row', className: styles$30.Week, key: index },
        week.map(renderWeek)
    ));
    return React.createElement(
        'div',
        { role: 'grid', className: styles$30.Month },
        React.createElement(
            'div',
            { className: className },
            dates.Months[month],
        ...
        React.createElement(
            'div',
            { role: 'rowheader', className: styles$30.WeekHeadings },
            weekdays
        ),
        weeksMarkup
    );
...
class DatePicker$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
            hoverDate: undefined,
    ...
    render() {
        ...
        var _props$weekStartsOn = _props.weekStartsOn;
        const weekStartsOn = _props$weekStartsOn === undefined ? dates.Weekdays.Sunday : _props$weekStartsOn,
              intl = _props.polaris.intl;
        var _state = this.state;
        const hoverDate = _state.hoverDate,
        ...
        return React.createElement(
            ...
            React.createElement(
                'div',
                { className: styles$30.MonthContainer },
    ...
    handleKeyUp(event) {
        const key = event.key;
        var _props2 = this.props;
        const selected = _props2.selected,
    ...
    setFocusDateAndHandleMonthChange(date) {
        const onMonthChange = this.props.onMonthChange;
    ...
    handleDateSelection(range) {
        ...
        const onChange = _props$onChange === undefined ? other.noop : _props$onChange;
...
var styles$31 = {
  "DescriptionList": "p_u9",
  "Term": "p_qz",
  "Description": "p_av",
};

const getUniqueTermKey = other.createUniqueIDFactory(`Term`);
const getUniqueDescriptionKey = other.createUniqueIDFactory(`Description`);
function DescriptionList$1({ items }) {
    const terms = items.reduce((allTerms, { term, description }) => [...allTerms, React.createElement(
        'dt',
        { key: getUniqueTermKey(), className: styles$31.Term },
        term
    ), React.createElement(
        'dd',
        { key: getUniqueDescriptionKey(), className: styles$31.Description },
        description
    )], []);
    return React.createElement(
        'dl',
        { className: styles$31.DescriptionList },
        terms
    );
}
...
function DisplayText$1({ element: Element = 'p', children, size = 'medium' }) {
    const className = styles.classNames(styles$32.DisplayText, size && styles$32[styles.variationName('size', size)]);
    return React.createElement(
        Element,
        { className: className },
        children
...
function Label$1({ children, id, hidden }) {
    const className = styles.classNames(styles$33.Label, hidden && styles$33.hidden);
    return React.createElement(
        'div',
        { className: className },
        React.createElement(
...
function Labelled$1(_a) {
  ...
  const className = styles.classNames(labelHidden && styles$34.hidden);
  ...
  const errorMarkup = error && typeof error !== 'boolean' && React.createElement(
    'div',
    { className: styles$34.Error },
    React.createElement(InlineError$1, { message: error, fieldID: id })
  );
  const labelMarkup = label ? React.createElement(
    'div',
...
function Link$2({ url, children, onClick, external, id }) {
  return url ? React.createElement(
    UnstyledLink$2,
    { onClick: onClick, className: styles$35.Link, url: url, external: external, id: id },
    children
  ) : React.createElement(
    'button',
    { onClick: onClick, className: styles$35.Link, id: id },
    children
  );
}
...
class FileUpload$1 extends React.Component {
    constructor(props, context) {
        super(props);
    ...
    updateStateFromProps(props) {
        var _state = this.state;
        const actionTitle = _state.actionTitle,
    ...
    render() {
        var _context = this.context;
        const size = _context.size,
              type = _context.type;
        var _state2 = this.state;
        const actionTitle = _state2.actionTitle,
              actionHint = _state2.actionHint;

        const imageClasses = styles.classNames(styles$36.Image, size && size === 'extraLarge' && styles$36.sizeExtraLarge, size && size === 'large' && styles$36.sizeLarge);
        const extraLargeView = size === 'extraLarge' ? React.createElement(
            Stack$1,
            { vertical: true },
        ...
        const largeView = size === 'large' ? React.createElement(
            Stack$1,
        ...
        const mediumView = size === 'medium' ? React.createElement(
            Stack$1,
            { vertical: true, spacing: 'tight' },
            React.createElement(
                Link$2,
        ...
        const smallView = size === 'small' ? React.createElement(
            Stack$1,
            { vertical: true, spacing: 'tight' },
        ...
        return React.createElement(
            'div',
            { className: styles$36.FileUpload },
            smallView,
            mediumView,
            largeView,
            extraLargeView
...
FileUpload$1.contextTypes = {
    size: PropTypes.string,
    type: PropTypes.string
};
var FileUpload$2 = withAppProvider()(FileUpload$1);
...
const getUniqueID$3 = other.createUniqueIDFactory('DropZone');
class DropZone$1 extends React.Component {
    constructor(props) {
        super(props);
        this.node = null;
        this.dropNode = null;
    ...
    render() {
        ...
        const classes = styles.classNames(styles$37.DropZone, outline && styles$37.hasOutline, (active || dragging) && styles$37.isDragging, error && styles$37.hasError, size && size === 'extraLarge' && styles$37.sizeExtraLarge, size && size === 'large' && styles$37.sizeLarge, size && size === 'medium' && styles$37.sizeMedium, size && size === 'small' && styles$37.sizeSmall);
        const dragOverlay = (active || dragging) && !error && overlay ? React.createElement(
            'div',
            { className: styles$37.Overlay },
            React.createElement(
                Stack$1,
                { vertical: true, spacing: 'tight' },
        ...
        const dragErrorOverlay = dragging && error ? React.createElement(
            'div',
            { className: styles$37.Overlay },
            React.createElement(
                Stack$1,
        ...
        const dropZoneMarkup = React.createElement(
            'div',
    ...
    setNode(node) {
        const dropOnPage = this.props.dropOnPage;
    ...
    handleDrop(event) {
        ...
        event.stopPropagation();
        var _props4 = this.props;
        const disabled = _props4.disabled,
        ...
        const files = _getValidatedFiles.files,
    ...
    handleDragEnter(event) {
        ...
        const dragging = this.state.dragging;
        var _props5 = this.props;
        const disabled = _props5.disabled,
        ...
        const rejectedFiles = _getValidatedFiles2.rejectedFiles;
    ...
    handleDragOver(event) {
        ...
        const disabled = _props6.disabled,
    ...
    handleDragLeave(event) {
        ...
        const disabled = _props7.disabled,
...
class EmptySearchResult$1 extends React.PureComponent {
    render() {
        var _props = this.props;
        ...
        const descriptionMarkup = description ? React.createElement(
            'p',
            null,
            description
        ) : null;
        const illustrationMarkup = withIllustration ? React.createElement(Image$1, { alt: altText, source: emptySearch, className: styles$38.Image, draggable: false }) : null;
        return React.createElement(
            Stack$1,
...
var styles$39 = {
  ...
  "Section": "p_le",
  "ImageContainer": "p_gc",
  "DetailsContainer": "p_of",
  "Details": "p_gn",
  "Content": "p_ls",
  "Actions": "p_us",
};

class EmptyState$1 extends React.PureComponent {
  render() {
    var _props = this.props;
    const children = _props.children,
    ...
    const className = styles.classNames(styles$39.EmptyState, imageContained && styles$39.imageContained);
    const imageMarkup = largeImage ? React.createElement(Image$1, { alt: '', role: 'presentation', className: styles$39.Image, source: largeImage, sourceSet: [{ source: image, descriptor: '568w' }, { source: largeImage, descriptor: '1136w' }], sizes: '(max-width: 568px) 60vw' }) : React.createElement(Image$1, { role: 'presentation', alt: '', className: styles$39.Image, source: image });
    const secondaryActionMarkup = secondaryAction ? buttonFrom(secondaryAction, { plain: true }) : null;
    return React.createElement(
      'div',
      { className: className },
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: styles$39.DetailsContainer },
          React.createElement(
            'div',
            { className: styles$39.Details },
            React.createElement(
              TextContainer$1,
              null,
              React.createElement(
        ...
        React.createElement(
          'div',
          { className: styles$39.ImageContainer },
          imageMarkup
        )
      )
    );
...
function Truncate$1({ children }) {
    return React.createElement(
        'span',
        { className: styles$40.Truncate },
        children
    );
}
...
function ExceptionList$1({ items: itemsList }) {
  const items = itemsList.map((item, index) => {
    const status = item.status,
          icon = item.icon,
          title = item.title,
          description = item.description;
    var _item$truncate = item.truncate;
    const truncate = _item$truncate === undefined ? false : _item$truncate;

    const itemClasses = styles.classNames(styles$41.Item, status && styles$41[styles.variationName('status', status)]);
    const iconMarkup = icon ? React.createElement(Icon$2, { source: icon }) : React.createElement('span', { className: styles$41.Bullet });
    const titleMarkup = title && React.createElement(
      'span',
      { className: styles$41.Title },
      title
    );
    const descriptionMarkup = description && React.createElement(
      'span',
      { className: styles$41.Description },
      description
    );
    const Element = truncate ? Truncate$1 : React.Fragment;
    return React.createElement(
      'li',
      { className: itemClasses, key: index },
      React.createElement(
        'span',
        { className: styles$41.Icon },
        iconMarkup
      ),
      React.createElement(
        Element,
  ...
  return React.createElement(
    'ul',
    { className: styles$41.ExceptionList },
    items
  );
}

class Focus$1 extends React.PureComponent {
    componentDidMount() {
        fastdom.write(() => {
...
class TrapFocus extends React.PureComponent {
    render() {
        const children = this.props.children;
    ...
    handleBlur(event) {
        ...
        const trapping = _props$trapping === undefined ? true : _props$trapping;
...
function FooterHelp$1({ children }) {
  return React.createElement(
    'div',
    { className: styles$42.FooterHelp },
    React.createElement(
      'div',
      { className: styles$42.Content },
      React.createElement(
        'div',
        { className: styles$42.Icon },
        React.createElement(Icon$2, { source: 'help', color: 'teal', backdrop: true })
      ),
      React.createElement(
        'div',
        { className: styles$42.Text },
        children
      )
    )
  );
...
class Form$1 extends React.PureComponent {
    render() {
        var _props = this.props;
        const acceptCharset = _props.acceptCharset,
              action = _props.action,
              autoComplete = _props.autoComplete,
              children = _props.children,
              encType = _props.encType;
        var _props$implicitSubmit = _props.implicitSubmit;
        const implicitSubmit = _props$implicitSubmit === undefined ? true : _props$implicitSubmit,
        ...
        const submitMarkup = implicitSubmit ? React.createElement(
            VisuallyHidden$1,
            null,
    ...
    handleSubmit(event) {
        ...
        const preventDefault = _props2$preventDefaul === undefined ? true : _props2$preventDefaul,
...
function Item$9(props) {
    return React.createElement(
        'div',
        { className: styles$43.Item },
        props.children
    );
}

const getUniqueID$4 = other.createUniqueIDFactory('FormLayoutGroup');
function Group$1({ children, condensed, title, helpText }) {
    const className = styles.classNames(condensed && styles$43.condensed);
    ...
    if (helpText) {
        ...
        helpTextElement = React.createElement(
            'div',
            { id: helpTextID, className: styles$43.HelpText },
            helpText
        );
    }
    if (title) {
        ...
        titleElement = React.createElement(
            'div',
            { id: titleID, className: styles$43.Title },
            title
        );
    }
    const itemsMarkup = React.Children.map(children, child => reactUtilities.wrapWithComponent(child, Item$9));
    return React.createElement(
        'div',
...
class FormLayout$1 extends React.PureComponent {
    render() {
        const children = this.props.children;

        return React.createElement(
            'div',
            { className: styles$43.FormLayout },
...
function KeyboardKey$1({ children }) {
    ...
    return React.createElement(
        'kbd',
        { className: styles$44.KeyboardKey },
        key
    );
}

class KeypressListener$1 extends React.Component {
    componentDidMount() {
...
var styles$45 = {
  "Layout": "p_lu",
  "Section": "p_zo",
  "Section-secondary": "p_ew",
  "Section-fullWidth": "p_zt",
  "AnnotatedSection": "p_qg",
  "AnnotationWrapper": "p_du",
  "AnnotationContent": "p_c9",
  "Annotation": "p_vi",
  "AnnotationDescription": "p_oy",
};
...
function AnnotatedSection$1(props) {
  ...
  const descriptionMarkup = typeof description === 'string' ? React.createElement(
    'p',
    null,
    description
  ) : description;
  return React.createElement(
    'div',
    { className: styles$45.AnnotatedSection },
    React.createElement(
      'div',
      { className: styles$45.AnnotationWrapper },
      React.createElement(
        'div',
        { className: styles$45.Annotation },
        React.createElement(
          TextContainer$1,
          null,
          React.createElement(
          ...
          descriptionMarkup && React.createElement(
            'div',
            { className: styles$45.AnnotationDescription },
            descriptionMarkup
          )
        )
      ),
      React.createElement(
        'div',
        { className: styles$45.AnnotationContent },
        children
      )
    )
  );
...
function Section$5({ children, secondary, fullWidth }) {
    const className = styles.classNames(styles$45.Section, secondary && styles$45['Section-secondary'], fullWidth && styles$45['Section-fullWidth']);
    return React.createElement(
        'div',
        { className: className },
        children
...
class Layout$1 extends React.Component {
    render() {
        var _props = this.props;
        const children = _props.children,
              sectioned = _props.sectioned;
...
function Item$11({ children }) {
    return React.createElement(
        'li',
        { className: styles$46.Item },
        children
    );
}
...
class ContentList extends React.PureComponent {
    render() {
        ...
        const type = _props$type === undefined ? 'bullet' : _props$type;

        const className = styles.classNames(styles$46.List, type && styles$46[styles.variationName('type', type)]);
...
ContentList.Item = Item$11;

function memoizedBind(callback, ...args) {
...
function DialogContainer(props) {
  return React.createElement(
    'div',
    { className: styles$47.Container, 'data-polaris-layer': true, 'data-polaris-overlay': true },
    props.children
  );
}
function Dialog$1(_a) {
  ...
  const classes = styles.classNames(styles$47.Modal, large && styles$47.sizeLarge, limitHeight && styles$47.limitHeight);
  const handleClose = memoizedBind$1(onClose);
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(KeypressListener$1, { keyCode: exports.Keys.ESCAPE, handler: handleClose }),
          children
        )
      )
    )
...
function Footer$1({ primaryAction, secondaryActions, children }) {
  ...
  const actions = primaryActionButton || secondaryActionButtons ? React.createElement(
    ButtonGroup$1,
    null,
  ...
  return React.createElement(
    'div',
    { className: styles$48.Footer },
    React.createElement(
      'div',
      { className: styles$48.FooterContent },
      React.createElement(
        Stack$1,
        { alignment: 'center' },
        React.createElement(
...
function Header$3({ id, children, onClose }) {
  const handleClose = memoizedBind$1(onClose);
  return React.createElement(
    'div',
...
function CloseButton({ title = true, onClick }) {
    const className = reactUtilities.classNames(styles$49.CloseButton, !title && styles$49.withoutTitle);
    return React.createElement(
        'button',
...
function Section$7({ children, flush = false, subdued = false }) {
    const className = styles.classNames(styles$50.Section, flush && styles$50.flush, subdued && styles$50.subdued);
    return React.createElement(
        'section',
        { className: className },
        children
...
const getUniqueID$5 = other.createUniqueIDFactory('modal-header');
class Modal$2 extends React.Component {
    constructor() {
        super(...arguments);
        this.state = {
            iframeHeight: IFRAME_LOADING_HEIGHT
        };
        this.headerId = getUniqueID$5();
    }
    getChildContext() {
        return {
            withinContentContainer: true
    ...
    render() {
        ...
        const children = _props.children,
              ...
              intl = _props.polaris.intl;
        const iframeHeight = this.state.iframeHeight;
        ...
        let backdrop;
        if (open) {
            const footerMarkup = !footer && !primaryAction && !secondaryActions ? null : React.createElement(
                Footer$1,
                { primaryAction: primaryAction, secondaryActions: secondaryActions },
                footer
            );
            const content = sectioned ? reactUtilities.wrapWithComponent(children, Section$7) : children;
            const body = loading ? React.createElement(
                'div',
                { className: styles$51.Spinner },
                React.createElement(Spinner$2, null)
            ) : content;
            const bodyMarkup = src ? React.createElement('iframe', { name: iFrameName, title: iframeTitle, src: src, className: styles$51.IFrame, onLoad: this.handleIFrameLoad, style: { height: `${iframeHeight}px` } }) : React.createElement(
                Scrollable$2,
                { shadow: true, className: styles$51.Body },
                body
            );
            const headerMarkup = title ? React.createElement(
                Header$3,
                { id: this.headerId, onClose: handleClose },
                title
            ) : React.createElement(CloseButton, { onClick: handleClose, title: false });
            dialog = React.createElement(
                Dialog$1,
                { instant: instant, labelledBy: this.headerId, onClose: handleClose, onEntered: this.handleEntered, onExited: this.handleExited, large: large, limitHeight: limitHeight },
                headerMarkup,
                React.createElement(
                    'div',
            ...
            backdrop = React.createElement('div', { className: styles$51.Backdrop, onClick: handleClose });
        }
    ...
    handleEntered() {
        const onTransitionEnd = this.props.onTransitionEnd;
    ...
    handleExited() {
        ...
        if (this.focusReturnPointNode) {
            fastdom.write(() => focus.focusFirstFocusableNode(this.focusReturnPointNode, false));
        }
    }
    handleIFrameLoad(evt) {
        ...
        const onIFrameLoad = this.props.onIFrameLoad;
    ...
    handleEASDKMessaging() {
        const easdk = this.context.easdk;
        const open = this.props.open;
    ...
    handleWarning(type) {
        ...
        const missingProps = Object.keys(reqProps[type]).reduce((acc, key) => {
        ...
        const actionWarnings = handleActionWanrings(this.props.primaryAction, this.props.secondaryActions);
...
Modal$2.contextTypes = { easdk: PropTypes.object };
...
function handleActionWanrings(primary = {}, secondary = []) {
    const actions = [primary, ...secondary];
    const actionKeysToIgnore = ['icon', 'loading'];
    return actions.reduce((acc, action) => {
        return acc.concat(...actionKeysToIgnore.filter(val => action[val] && acc.indexOf(val) === -1 && val));
    }, []);
}
...
class Option$1 extends React.Component {
    constructor() {
        super(...arguments);
        this.state = {
            focused: false,
    ...
    render() {
        ...
        const mediaMarkup = media ? React.createElement(
            'div',
            { className: styles$52.Media },
            media
        ) : null;
        const singleSelectClassName = styles.classNames(styles$52.SingleSelectOption, focused && styles$52.focused, disabled && styles$52.disabled, select && styles$52.select, active && styles$52.active);
        const multiSelectClassName = styles.classNames(styles$52.Label, active && styles$52.active);
        const checkBoxRole = role === 'option' ? 'presentation' : undefined;
        const optionMarkup = allowMultiple ? React.createElement(
            'label',
            { htmlFor: id, className: multiSelectClassName },
            React.createElement(
                'div',
                { className: styles$52.Checkbox },
                React.createElement(Checkbox$4, { id: id, value: value, checked: select, active: active, disabled: disabled, onChange: this.handleClick, role: checkBoxRole })
            ),
            mediaMarkup,
            label
        ) : React.createElement(
            'button',
            { type: 'button', className: singleSelectClassName, onClick: this.handleClick, disabled: disabled, onFocus: this.toggleFocus, onBlur: this.toggleFocus },
            mediaMarkup,
            label
        );
        const scrollMarkup = active ? React.createElement(Scrollable$2.ScrollTo, null) : null;
        return React.createElement(
            'li',
            { key: id, className: styles$52.Option, tabIndex: -1, 'aria-selected': active, role: role },
            scrollMarkup,
            optionMarkup
        );
    }
...
const getUniqueID$6 = other.createUniqueIDFactory('Checkbox');
function Checkbox$4({ id = getUniqueID$6(), checked = false, disabled, active, onChange, name, value, role }) {
  const className = styles.classNames(styles$53.Checkbox, active && styles$53.active);
  return React.createElement(
    'div',
    { className: className },
    React.createElement('input', { id: id, name: name, value: value, type: 'checkbox', checked: checked, disabled: disabled, className: styles$53.Input, 'aria-checked': checked, onChange: onChange, role: role }),
    React.createElement('div', { className: styles$53.Backdrop }),
    React.createElement(
      'div',
      { className: styles$53.Icon },
...
const getUniqueId = other.createUniqueIDFactory('OptionList');
class OptionList$1 extends React.Component {
    constructor() {
        super(...arguments);
        this.state = {
    ...
    componentWillReceiveProps({ options: nextOptions = [], sections: nextSections = [], id: nextID, title: nextTitle }) {
        ...
        const options = _props$options === undefined ? [] : _props$options;
        var _props$sections = _props.sections;
        const sections = _props$sections === undefined ? [] : _props$sections,
              id = _props.id,
              title = _props.title;
    ...
    render() {
        const normalizedOptions = this.state.normalizedOptions;
        var _props2 = this.props;
        const selected = _props2.selected,
              allowMultiple = _props2.allowMultiple,
              role = _props2.role,
        ...
        const optionsMarkup = optionsExist ? normalizedOptions.map(({ title, options }, sectionIndex) => {
            const titleMarkup = title ? React.createElement(
                'p',
                { className: styles$54.Title, role: 'presentation' },
                title
            ) : null;
            const optionsMarkup = options && options.map((option, optionIndex) => {
                const isSelected = selected.includes(option.value);
                const id = option.id || `${this.id}-${sectionIndex}-${optionIndex}`;
                return React.createElement(Option$1, Object.assign({}, option, { key: id, id: id, section: sectionIndex, index: optionIndex, onClick: this.handleClick, select: isSelected, allowMultiple: allowMultiple, role: optionRole }));
            });
            return React.createElement(
                'li',
                { key: title || `noTitle-${sectionIndex}`, className: styles$54.Options },
                titleMarkup,
                React.createElement(
                    'ul',
                    { className: styles$54.Options, id: this.id, role: role, 'aria-multiselectable': allowMultiple },
                    optionsMarkup
                )
            );
        }) : null;
        return React.createElement(
            'ul',
            { className: styles$54.OptionList },
            optionsMarkup
        );
    }
    handleClick(sectionIndex, optionIndex) {
        var _props3 = this.props;
        const selected = _props3.selected,
              onChange = _props3.onChange,
...
function testSectionsPropEquality(previousSection, currentSection) {
    const previousOptions = previousSection.options;
    const currentOptions = currentSection.options;
...
var styles$55 = {
  ...
  "Content": "p_nw",
  "Header": "p_hz",
  "Header-hasPagination": "p_ly",
  "Header-hasBreadcrumbs": "p_wy",
  "Header-hasSecondaryActions": "p_dp",
  "Header-hasSeparator": "p_ac",
  "Header-hasRollup": "p_m9",
  "IndividualActions": "p_ak",
  "Rollup": "p_yy",
  "Navigation": "p_pw",
  "Pagination": "p_w4",
  "MainContent": "p_pj",
  "TitleAndActions": "p_m7",
  "Title": "p_do",
  "Title-hidden": "p_jz",
  "Actions": "p_x3",
  "SecondaryActions": "p_j9",
  "Action": "p_y7",
  "ActionGroup": "p_if",
  "PrimaryAction": "p_bt",
  "ActionIcon": "p_by",
...
function Action$1({ icon, url, external, onAction, children, disclosure, accessibilityLabel, disabled, showIndicator, hasIndicator }) {
  const iconMarkup = icon ? React.createElement(
    'span',
    { className: styles$55.ActionIcon },
    React.createElement(Icon$2, { source: icon })
  ) : null;
  const disclosureIconMarkup = disclosure ? React.createElement(
    'span',
  ...
  const contentMarkup = iconMarkup || disclosureIconMarkup ? React.createElement(
    'span',
    { className: styles$55.ActionContent },
    iconMarkup,
    React.createElement(
      'span',
      null,
  ...
  if (url) {
    return React.createElement(
      UnstyledLink$2,
      { key: children, external: external, url: url, onMouseUp: handleMouseUpByBlurring, className: styles$55.Action, 'aria-label': accessibilityLabel },
      contentMarkup
    );
  }
  const indicatorMarkup = false && showIndicator && !hasIndicator && React.createElement(Indicator$1, null);
  const className = reactUtilities.classNames(styles$55.Action, disabled && styles$55.disabled, icon && children == null && styles$55.iconOnly, false && showIndicator && styles$55['Action-outline']);
  return React.createElement(
    'button',
...
class Breadcrumbs$1 extends React.PureComponent {
  render() {
    ...
    const content = breadcrumb.content;

    const contentMarkup = React.createElement(
      React.Fragment,
      null,
      React.createElement(
        'span',
        { className: styles$56.Icon },
        React.createElement(Icon$2, { source: 'chevronLeft' })
      ),
      React.createElement(
        'span',
        { className: styles$56.Content },
        content
      )
    );
    const breadcrumbMarkup = 'url' in breadcrumb ? React.createElement(
      UnstyledLink$2,
      { key: content, url: breadcrumb.url, className: styles$56.Breadcrumb, onMouseUp: handleMouseUpByBlurring },
      contentMarkup
    ) : React.createElement(
      'button',
      { key: content, className: styles$56.Breadcrumb, onClick: breadcrumb.onAction, onMouseUp: handleMouseUpByBlurring, type: 'button' },
      contentMarkup
    );
    return (
...
const getUniqueID$8 = other.createUniqueIDFactory('portal-');
class Portal$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.portalId = this.props.idPrefix !== '' ? `${this.props.idPrefix}-${getUniqueID$8()}` : getUniqueID$8();
    }
    componentWillMount() {
        if (target.isServer) {
            return;
...
class ScrollTo$1 extends React.Component {
    constructor() {
        super(...arguments);
        this.ref = React.createRef();
    }
    componentDidMount() {
        const scrollToPosition = this.context.scrollToPosition;
    ...
    render() {
        const getUniqueId = other.createUniqueIDFactory(`ScrollTo`);
...
class Scrollable$1 extends React.Component {
    constructor() {
        super(...arguments);
        this.state = {
            topShadow: false,
    ...
    componentDidMount() {
        const polaris = this.props.polaris;

        if (this.scrollArea == null) {
            return;
        }
        polaris.stickyManager.setContainer(this.scrollArea);
        events.addEventListener(this.scrollArea, 'scroll', () => {
    ...
    render() {
        var _state = this.state;
        const topShadow = _state.topShadow,
              bottomShadow = _state.bottomShadow;
        const _a = this.props,
              children = _a.children,
              className = _a.className,
              horizontal = _a.horizontal;var _a$vertical = _a.vertical;

        const vertical = _a$vertical === undefined ? true : _a$vertical,
              shadow = _a.shadow,
              hint = _a.hint,
              rest = tslib_1.__rest(_a, ["children", "className", "horizontal", "vertical", "shadow", "hint"]);

        const finalClassName = styles.classNames(className, styles$57.Scrollable, vertical && styles$57.vertical, horizontal && styles$57.horizontal, topShadow && styles$57.hasTopShadow, bottomShadow && styles$57.hasBottomShadow);
        return React.createElement(
            'div',
...
function rectIsOutsideOfRect(inner, outer) {
    const center = inner.center;

    return center.y < outer.top || center.y > outer.top + outer.height;
}

var styles$58 = {
  "PositionedOverlay": "p_y5",
  "fixed": "p_sr",
  "calculating": "p_ln",
};

class PositionedOverlay$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
            measuring: true,
    ...
    componentDidUpdate() {
        var _state = this.state;
        const outsideScrollableContainer = _state.outsideScrollableContainer,
              top = _state.top;
        var _props = this.props;
        const onScrollOut = _props.onScrollOut,
              active = _props.active;
    ...
    render() {
        var _state2 = this.state;
        const left = _state2.left,
              top = _state2.top,
              zIndex = _state2.zIndex,
              width = _state2.width;
        var _props2 = this.props;
        const render = _props2.render,
              fixed = _props2.fixed;
        ...
        const className = styles.classNames(styles$58.PositionedOverlay, fixed && styles$58.fixed);
        return React.createElement(
            'div',
    ...
    overlayDetails() {
        var _state3 = this.state;
        const measuring = _state3.measuring,
              left = _state3.left,
    ...
    handleMeasurement() {
        ...
        const lockPosition = _state4.lockPosition,
              top = _state4.top;
        ...
        this.setState({
            ...
            var _props3 = this.props;
            const activator = _props3.activator;
            var _props3$preferredPosi = _props3.preferredPosition;
            const preferredPosition = _props3$preferredPosi === undefined ? 'below' : _props3$preferredPosi;
            var _props3$preferredAlig = _props3.preferredAlignment;
            const preferredAlignment = _props3$preferredAlig === undefined ? 'center' : _props3$preferredAlig,
                  onScrollOut = _props3.onScrollOut,
                  fullWidth = _props3.fullWidth,
                  fixed = _props3.fixed;

            const activatorRect = geometry.getRectForNode(activator);
...
function getZIndexForLayerFromNode(node) {
    const layerNode = dom.closest(node, layer.selector) || document.body;
...
class TooltipOverlay$1 extends React.PureComponent {
    render() {
    ...
    renderOverlay() {
        ...
        var _props$preferredPosit = _props.preferredPosition;
        const preferredPosition = _props$preferredPosit === undefined ? 'below' : _props$preferredPosit;
    ...
    renderTooltip(overlayDetails) {
        const left = overlayDetails.left,
        ...
        const containerClassName = styles.classNames(styles$59.Tooltip, light && styles$59.light, measuring && styles$59.measuring, positioning === 'above' && styles$59.positionedAbove);
        const contentStyles = measuring ? undefined : { maxHeight: desiredHeight };
        const tipMarkup = !measuring ? React.createElement('div', { style: tipStyle, className: styles$59.Tip }) : null;
        return React.createElement(
            'div',
            ...
            React.createElement(
                'div',
                { className: styles$59.Wrapper },
                React.createElement(
                    'div',
                    { id: id, role: 'tooltip', className: styles$59.Content, style: contentStyles },
                    children
                )
            )
        );
...
const getUniqueID$7 = other.createUniqueIDFactory('TooltipContent');
class Tooltip$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
    ...
    render() {
        ...
        var _props$preferredPosit = _props.preferredPosition;
        const preferredPosition = _props$preferredPosit === undefined ? 'below' : _props$preferredPosit;
        var _props$activatorWrapp = _props.activatorWrapper;
        const WrapperComponent = _props$activatorWrapp === undefined ? 'span' : _props$activatorWrapp;
        var _state = this.state;
        const active = _state.active,
              activatorNode = _state.activatorNode;

        const portal = activatorNode ? React.createElement(
            Portal$1,
            { idPrefix: 'tooltip' },
            React.createElement(
                TooltipOverlay$1,
    ...
    setAccessibilityAttributes() {
        const activatorContainer = this.activatorContainer,
              id = this.id;

        if (activatorContainer == null) {
            return;
        }
        const firstFocusable = focus.findFirstFocusableNode(activatorContainer);
...
function Pagination$1({ hasNext, hasPrevious, nextURL, previousURL, onNext, onPrevious, nextTooltip, previousTooltip, nextKeys, previousKeys, plain, accessibilityLabel, polaris: { intl } }) {
    let label;
    if (accessibilityLabel) {
        label = accessibilityLabel;
    } else {
    ...
    const className = reactUtilities.classNames(styles$60.Pagination, plain && styles$60.plain);
    const previousButton = previousURL ? React.createElement(
        UnstyledLink$2,
        { className: styles$60.Button, url: previousURL, onMouseUp: handleMouseUpByBlurring, 'aria-label': intl.translate('Polaris.Pagination.previous'), id: 'previousURL' },
        React.createElement(Icon$2, { source: 'arrowLeft' })
    ) : React.createElement(
        'button',
        { onClick: onPrevious, onMouseUp: handleMouseUpByBlurring, className: styles$60.Button, 'aria-label': intl.translate('Polaris.Pagination.previous'), disabled: !hasPrevious },
        React.createElement(Icon$2, { source: 'arrowLeft' })
    );
    const nextButton = nextURL ? React.createElement(
        UnstyledLink$2,
        { className: styles$60.Button, url: nextURL, onMouseUp: handleMouseUpByBlurring, 'aria-label': intl.translate('Polaris.Pagination.next'), id: 'nextURL' },
        React.createElement(Icon$2, { source: 'arrowRight' })
    ) : React.createElement(
        'button',
        { onClick: onNext, onMouseUp: handleMouseUpByBlurring, className: styles$60.Button, 'aria-label': intl.translate('Polaris.Pagination.next'), disabled: !hasNext },
        React.createElement(Icon$2, { source: 'arrowRight' })
    );
    const constructedPrevious = previousTooltip ? React.createElement(
        Tooltip$1,
        { content: previousTooltip },
        previousButton
    ) : previousButton;
    const constructedNext = nextTooltip ? React.createElement(
        Tooltip$1,
        { content: nextTooltip },
        nextButton
    ) : nextButton;
    const previousButtonEvents = previousKeys && (previousURL || onPrevious) && previousKeys.map(key => React.createElement(KeypressListener$1, { key: key, keyCode: key, handler: previousURL ? clickPaginationLink('previousURL') : onPrevious }));
    const nextButtonEvents = nextKeys && (nextURL || onNext) && nextKeys.map(key => React.createElement(KeypressListener$1, { key: key, keyCode: key, handler: nextURL ? clickPaginationLink('nextURL') : onNext }));
    return React.createElement(
        'nav',
...
function clickPaginationLink(id) {
    return () => {
...
var styles$61 = {
  ...
  "measuring": "p_ph",
  "exiting": "p_w0",
  "positionedAbove": "p_pb",
  "Tip": "p_s7",
  "Wrapper": "p_im",
  "Content-fullHeight": "p_r0",
  "Pane": "p_jf",
  "Pane-fixed": "p_cj",
  "Section": "p_w7",
  "FocusTracker": "p_xu",
...
function Pane$1({ fixed, sectioned, children }) {
    const className = styles.classNames(styles$61.Pane, fixed && styles$61['Pane-fixed']);
    const content = sectioned ? reactUtilities.wrapWithComponent(children, Section$9) : children;
...
class PopoverOverlay$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
    ...
    renderOverlay(transitionStatus) {
        ...
        var _props$preferredPosit = _props.preferredPosition;
        const preferredPosition = _props$preferredPosit === undefined ? 'below' : _props$preferredPosit;
        var _props$preferredAlign = _props.preferredAlignment;
        const preferredAlignment = _props$preferredAlign === undefined ? 'center' : _props$preferredAlign,
              fixed = _props.fixed;
    ...
    renderPopover(transitionStatus, overlayDetails) {
        const measuring = overlayDetails.measuring,
        ...
        const className = styles.classNames(styles$61.Popover, transitionStatus && animationVariations(transitionStatus), positioning === 'above' && styles$61.positionedAbove, fullWidth && styles$61.fullWidth, measuring && styles$61.measuring);
        this.transitionStatus = transitionStatus;
        const tipMarkup = !measuring ? React.createElement('div', { style: { left: activatorRect.center.x - left }, className: styles$61.Tip }) : null;
        const contentStyles = measuring ? undefined : { height: desiredHeight };
        const contentClassNames = styles.classNames(styles$61.Content, fullHeight && styles$61['Content-fullHeight']);
        ...
        return React.createElement(
            ...
            tipMarkup,
            React.createElement('div', { className: styles$61.FocusTracker
                // eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex
                , tabIndex: 0, onFocus: this.handleFocusFirstItem }),
            React.createElement(
                'div',
                { className: styles$61.Wrapper },
                content
            ),
            React.createElement('div', { className: styles$61.FocusTracker
                // eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex
    ...
    handleClick(event) {
        ...
        const isDescendant = contentNode.current != null && dom.nodeContainsDescendant(contentNode.current, target$$1);
        const isActivatorDescendant = dom.nodeContainsDescendant(activator, target$$1);
...
function animationVariations(status) {
    switch (status) {
        case 'exiting':
            return styles$61.exiting;
        default:
            return null;
    }
}

const getUniqueID$9 = other.createUniqueIDFactory('Popover');
class Popover$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
    ...
    render() {
        const _a = this.props;var _a$activatorWrapper = _a.activatorWrapper;

        const WrapperComponent = _a$activatorWrapper === undefined ? 'div' : _a$activatorWrapper,
              children = _a.children,
              onClose = _a.onClose,
        ...
        const activatorNode = this.state.activatorNode;
...
class Header$5 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
            rollupOpen: false
    ...
    render() {
        ...
        var _props$breadcrumbs = _props.breadcrumbs;
        const breadcrumbs = _props$breadcrumbs === undefined ? [] : _props$breadcrumbs;
        var _props$titleHidden = _props.titleHidden;
        const titleHidden = _props$titleHidden === undefined ? false : _props$titleHidden,
              primaryAction = _props.primaryAction,
              pagination = _props.pagination,
              separator = _props.separator,
              secondaryActions = _props.secondaryActions;

        const className = styles.classNames(styles$55.Header, titleHidden && styles$55['Title-hidden'], pagination && styles$55['Header-hasPagination'], separator && styles$55['Header-hasSeparator'], breadcrumbs && breadcrumbs.length && styles$55['Header-hasBreadcrumbs'], this.hasRollup && styles$55['Header-hasRollup'], secondaryActions && secondaryActions.length && styles$55['Header-hasSecondaryActions']);
        const breadcrumbMarkup = breadcrumbs.length > 0 ? React.createElement(Breadcrumbs$1, { breadcrumbs: breadcrumbs }) : null;
        const primary = primaryAction && (primaryAction.primary === undefined ? true : primaryAction.primary);
        const primaryActionMarkup = primaryAction ? React.createElement(
            'div',
            { className: styles$55.PrimaryAction },
            buttonsFrom(primaryAction, { primary })
        ) : null;
        const paginationMarkup = pagination ? React.createElement(
            'div',
            { className: styles$55.Pagination },
        ...
        const actionsMarkup = React.createElement(
            'div',
            { className: styles$55.Actions },
            primaryActionMarkup,
            nonPrimaryActionsMarkup
        );
        const navigationMarkup = breadcrumbMarkup || paginationMarkup ? React.createElement(
            'div',
            { className: styles$55.Navigation },
            breadcrumbMarkup,
            paginationMarkup
        ) : null;
        const titleMarkup = React.createElement(
            'div',
        ...
        return primaryActionMarkup ? React.createElement(
            ...
            React.createElement(
                'div',
                { className: styles$55.MainContent },
                React.createElement(
                    'div',
                    { className: styles$55.TitleAndActions },
                    titleMarkup,
                    actionsMarkup
                ),
                primaryActionMarkup
    ...
    get hasRollup() {
        ...
        const secondaryActions = _props2$secondaryActi === undefined ? [] : _props2$secondaryActi;
        var _props2$actionGroups = _props2.actionGroups;
        const actionGroups = _props2$actionGroups === undefined ? [] : _props2$actionGroups;

        return secondaryActions.length + actionGroups.length > 1;
    }
    renderSecondaryActions() {
        var _state = this.state;
        const openActionGroup = _state.openActionGroup,
              rollupOpen = _state.rollupOpen;
        var _props3 = this.props,
            _props3$secondaryActi = _props3.secondaryActions;
        const secondaryActions = _props3$secondaryActi === undefined ? [] : _props3$secondaryActi;
        var _props3$actionGroups = _props3.actionGroups;
        const actionGroups = _props3$actionGroups === undefined ? [] : _props3$actionGroups;
        ...
        const actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(({ title, icon, actions, details }) => {
            const detailsClassName = styles.classNames(styles$55.Details, actions && Array.isArray(actions) && actions.length > 0 && styles$55.withActions);
            const detailsMarkup = details ? React.createElement(
                'div',
            ...
            return React.createElement(
                'div',
                { className: styles$55.ActionGroup, key: `ActionGroup-${title}` },
                React.createElement(
                    Popover$1,
                    { key: title, active: active
                        // eslint-disable-next-line react/jsx-no-bind
                        , onClose: this.handleActionGroupClose.bind(this, title), activator: React.createElement(
                            Action$1,
        ...
        const showIndicator = false && actionGroups.filter(group => hasNewStatus(group.actions)).length > 0;
        const rollupMarkup = this.hasRollup ? React.createElement(
            'div',
            { className: styles$55.Rollup },
            React.createElement(
                Popover$1,
                { active: rollupOpen, onClose: this.handleRollupToggle, activator: React.createElement(
                        Button$2,
                        { outline: false && showIndicator, disclosure: true, onClick: this.handleRollupToggle },
                        'Actions'
                    ) },
        ...
        return React.createElement(
            'div',
            { className: styles$55.SecondaryActions },
            rollupMarkup,
            React.createElement(
                'div',
                { className: styles$55.IndividualActions },
                secondaryActionMarkup,
                actionGroupsMarkup
            )
        );
...
tslib_1.__decorate([decorators.autobind], Header$5.prototype, "handleRollupToggle", null);
function hasNewStatus(actions) {
    for (let i = 0; i < actions.length; i++) {
        const badge = actions[i].badge;
...
class Page$1 extends React.PureComponent {
    componentDidMount() {
    ...
    render() {
        ...
        const className = styles.classNames(styles$55.Page, fullWidth && styles$55.fullWidth, singleColumn && styles$55.singleColumn);
        const headerMarkup = this.props.polaris.easdk || !this.hasHeaderContent() ? null : React.createElement(Header$5, rest);
        return React.createElement(
            'div',
            { className: className },
            headerMarkup,
    ...
    handleEASDKMessaging() {
        const easdk = this.props.polaris.easdk;
...
var Page$2 = withAppProvider()(Page$1);
...
function PageActions$1({ primaryAction, secondaryActions }) {
  ...
  const secondaryActionsMarkup = secondaryActions ? React.createElement(
    ButtonGroup$1,
    null,
  ...
  return React.createElement(
    'div',
    { className: styles$62.PageActions },
    React.createElement(
      Stack$1,
...
const getUniqueID$10 = other.createUniqueIDFactory('RangeSlider');
const cssVarPrefix = '--Polaris-RangeSlider-';
class RangeSlider$1 extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            id: props.id || getUniqueID$10()
        };
    }
    static getDerivedStateFromProps(nextProps, prevState) {
    ...
    render() {
        ...
        const min = _props$min === undefined ? 0 : _props$min;
        var _props$max = _props.max;
        const max = _props$max === undefined ? 100 : _props$max;
        var _props2 = this.props;
        const label = _props2.label,
        ...
        const outputMarkup = !disabled && output && React.createElement(
            'output',
            { htmlFor: id, className: styles$63.Output },
            React.createElement(
                'div',
                { className: styles$63.OutputBubble },
                React.createElement(
                    'span',
                    { className: styles$63.OutputText },
                    value
                )
            )
        );
        const prefixMarkup = prefix && React.createElement(
            'div',
            { className: styles$63.Prefix },
            prefix
        );
        const suffixMarkup = suffix && React.createElement(
            'div',
            { className: styles$63.Suffix },
            suffix
        );
        const className = styles.classNames(styles$63.RangeSlider, error && styles$63.error, disabled && styles$63.disabled);
        return React.createElement(
            Labelled$1,
...
const getUniqueID$12 = other.createUniqueIDFactory('Select');
function Select$1({ options: optionsProp, groups: groupsProp, label, labelAction, labelHidden: labelHiddenProp, labelInline, disabled, helpText, placeholder, id = getUniqueID$12(), name, value = PLACEHOLDER_VALUE, error, onChange, onFocus, onBlur }) {
    const labelHidden = labelInline ? true : labelHiddenProp;
    const className = styles.classNames(styles$64.Select, error && styles$64.error, disabled && styles$64.disabled);
    ...
    const inlineLabelMarkup = labelInline && React.createElement(
        'span',
        { className: styles$64.InlineLabel },
        label
    );
    const selectedOption = getSelectedOption(normalizedOptions, value);
    const contentMarkup = React.createElement(
        'div',
        { className: styles$64.Content, 'aria-hidden': true },
        inlineLabelMarkup,
        React.createElement(
            'span',
            { className: styles$64.SelectedOption },
            selectedOption
        ),
        React.createElement(
            'span',
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
                'select',
                { id: id, name: name, value: value, className: styles$64.Input, disabled: disabled, onFocus: onFocus, onBlur: onBlur, onChange: handleChange, 'aria-invalid': Boolean(error), 'aria-describedby': describedBy.length ? describedBy.join(' ') : undefined },
                optionsMarkup
            ),
            contentMarkup,
            React.createElement('div', { className: styles$64.Backdrop })
        )
    );
}
...
function renderOption(optionOrGroup) {
    if (isGroup(optionOrGroup)) {
        const title = optionOrGroup.title,
...
var styles$65 = {
  "CheckableButton": "p_rk",
  "CheckableButton-measuring": "p_l7",
  "CheckableButton-plain": "p_qy",
  "CheckableButton-selectMode": "p_mk",
  "CheckableButton-selected": "p_vs",
  "Checkbox": "p_xs",
  "Label": "p_uk",
};

function CheckableButton$1({ accessibilityLabel, label = '', onToggleAll, selected, selectMode, plain, measuring }) {
    const className = plain ? styles.classNames(styles$65.CheckableButton, styles$65['CheckableButton-plain']) : styles.classNames(styles$65.CheckableButton, selectMode && styles$65['CheckableButton-selectMode'], selected && styles$65['CheckableButton-selected'], measuring && styles$65['CheckableButton-measuring']);
    return React.createElement(
        'div',
        { className: className, onClick: onToggleAll },
        React.createElement(
            'div',
            { className: styles$65.Checkbox },
            React.createElement(Checkbox$2, { label: accessibilityLabel, labelHidden: true, checked: selected })
        ),
        React.createElement(
            'span',
            { className: styles$65.Label },
            label
        )
    );
}
...
var styles$66 = {
  "Button": "p_e8",
  "Group-measuring": "p_ng",
  "Group": "p_vd",
  "Group-entering": "p_s5",
  "Group-exiting": "p_vy",
  "Group-entered": "p_fe",
  "Group-exited": "p_b5",
  "Group-smallScreen": "p_ys",
  "Group-largeScreen": "p_pi",
  "ButtonGroup": "p_dv",
  "Button-cancel": "p_xn",
  "Popover": "p_mi",
  "ActionContent": "p_m4",
  "ActionIcon": "p_ht",
  "disabled": "p_yv",
  "PaginatedSelectAll": "p_n5",
  "Slide": "p_dm",
  "Slide-appear": "p_a5",
  "Slide-enter": "p_gx",
  "Slide-exit": "p_yz",
  "Slide-appearing": "p_md",
  "Slide-entering": "p_r2",
};

class BulkActionButton extends React.PureComponent {
    componentDidMount() {
        const handleMeasurement = this.props.handleMeasurement;

        if (handleMeasurement) {
            const bulkActionButtonNode = ReactDOM.findDOMNode(this);
            const width = bulkActionButtonNode instanceof Element && bulkActionButtonNode.getBoundingClientRect().width || 0;
    ...
    render() {
        ...
        const disclosureIconMarkup = disclosure ? React.createElement(
            'span',
            { className: styles$66.ActionIcon },
            React.createElement(Icon$2, { source: 'caretDown' })
        ) : null;
        const contentMarkup = disclosureIconMarkup ? React.createElement(
            'span',
            { className: styles$66.ActionContent },
            React.createElement(
                'span',
                null,
                content
        ...
        if (url) {
            return React.createElement(
                UnstyledLink$2,
                { external: external, url: url, onMouseUp: handleMouseUpByBlurring, className: styles$66.Button, 'aria-label': accessibilityLabel },
                contentMarkup
            );
        }
        const className = reactUtilities.classNames(styles$66.Button, disabled && styles$66.disabled);
        return React.createElement(
            'button',
...
const slideClasses = {
    appear: styles.classNames(styles$66.Slide, styles$66['Slide-appear']),
    appearActive: styles.classNames(styles$66.Slide, styles$66['Slide-appearing']),
    enter: styles.classNames(styles$66.Slide, styles$66['Slide-enter']),
    enterActive: styles.classNames(styles$66.Slide, styles$66['Slide-entering']),
    exit: styles.classNames(styles$66.Slide, styles$66['Slide-exit'])
};
class BulkActions$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
    ...
    get numberOfPromotedActionsToRender() {
        const promotedActions = this.props.promotedActions;
        var _state = this.state;
        const containerWidth = _state.containerWidth,
    ...
    get hasActions() {
        var _props = this.props;
        const promotedActions = _props.promotedActions,
              actions = _props.actions;
    ...
    render() {
        var _props3 = this.props;
        const selectMode = _props3.selectMode,
              accessibilityLabel = _props3.accessibilityLabel;
        var _props3$label = _props3.label;
        const label = _props3$label === undefined ? '' : _props3$label,
              onToggleAll = _props3.onToggleAll,
              selected = _props3.selected,
              promotedActions = _props3.promotedActions;
        var _props3$paginatedSele = _props3.paginatedSelectAllText;
        const paginatedSelectAllText = _props3$paginatedSele === undefined ? null : _props3$paginatedSele,
              paginatedSelectAllAction = _props3.paginatedSelectAllAction,
        ...
        var _state2 = this.state;
        const smallScreenPopoverVisible = _state2.smallScreenPopoverVisible,
              largeScreenPopoverVisible = _state2.largeScreenPopoverVisible,
              measuring = _state2.measuring;

        const paginatedSelectAllActionMarkup = paginatedSelectAllAction ? React.createElement(
            Button$2,
            { onClick: paginatedSelectAllAction.onAction, plain: true },
            paginatedSelectAllAction.content
        ) : null;
        const paginatedSelectAllTextMarkup = paginatedSelectAllText && paginatedSelectAllAction ? React.createElement(
            'span',
            { 'aria-live': 'polite' },
            paginatedSelectAllText
        ) : paginatedSelectAllText;
        const paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? React.createElement(
            'div',
            { className: styles$66.PaginatedSelectAll },
            paginatedSelectAllTextMarkup,
            ' ',
            paginatedSelectAllActionMarkup
        ) : null;
        const cancelButtonClassName = styles.classNames(styles$66.Button, styles$66['Button-cancel']);
        ...
        const allActionsPopover = this.hasActions ? React.createElement(
            'div',
            { className: styles$66.Popover, ref: this.setMoreActionsNode },
            React.createElement(
                Popover$1,
                { active: smallScreenPopoverVisible, activator: React.createElement(BulkActionButton, { disclosure: true, onAction: this.toggleSmallScreenPopover, content: intl.translate('Polaris.ResourceList.BulkActions.actionsActivatorLabel') }), onClose: this.toggleSmallScreenPopover },
        ...
        const promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0 ? [...promotedActions].slice(0, numberOfPromotedActionsToRender).map((action, index) => React.createElement(BulkActionButton, Object.assign({}, action, { key: index, handleMeasurement: this.handleMeasurement }))) : null;
        ...
        const activatorLabel = !promotedActions || promotedActions && numberOfPromotedActionsToRender === 0 && !measuring ? intl.translate('Polaris.ResourceList.BulkActions.actionsActivatorLabel') : intl.translate('Polaris.ResourceList.BulkActions.moreActionsActivatorLabel');
        let combinedActions = [];
        ...
        const actionsPopover = this.actionSections || rolledInPromotedActions.length > 0 || measuring ? React.createElement(
            'div',
            { className: styles$66.Popover, ref: this.setMoreActionsNode },
            React.createElement(
                Popover$1,
                { active: largeScreenPopoverVisible, activator: React.createElement(BulkActionButton, { disclosure: true, onAction: this.toggleLargeScreenPopover, content: activatorLabel }), onClose: this.toggleLargeScreenPopover },
        ...
        const smallScreenGroup = React.createElement(
            reactTransitionGroup.Transition,
            { timeout: 0, 'in': selectMode, key: 'smallGroup' },
            status => {
                const smallScreenGroupClassName = styles.classNames(styles$66.Group, styles$66['Group-smallScreen'], styles$66[`Group-${status}`]);
                return React.createElement(
                    'div',
                    { className: smallScreenGroupClassName },
                    React.createElement(
                        'div',
                        { className: styles$66.ButtonGroup },
                        React.createElement(
                            reactTransitionGroup.CSSTransition,
        ...
        const largeScreenGroup = React.createElement(
            reactTransitionGroup.Transition,
            { timeout: 0, 'in': selectMode, key: 'largeGroup' },
            status => {
                const largeScreenGroupClassName = styles.classNames(styles$66.Group, styles$66['Group-largeScreen'], !measuring && styles$66[`Group-${status}`], measuring && styles$66['Group-measuring']);
                return React.createElement(
                    'div',
                    ...
                    React.createElement(
                        'div',
                        { className: styles$66.ButtonGroup, ref: this.setLargeScreenButtonsNode },
                        React.createElement(CheckableButton$2, checkableButtonProps),
    ...
    setSelectMode(val) {
        const onSelectModeToggle = this.props.onSelectModeToggle;
    ...
    handleResize() {
        var _state3 = this.state;
        const smallScreenPopoverVisible = _state3.smallScreenPopoverVisible,
              largeScreenPopoverVisible = _state3.largeScreenPopoverVisible;
...
(function (DateFilterOptions) {
    DateFilterOptions["PastWeek"] = "past_week";
    DateFilterOptions["PastMonth"] = "past_month";
    DateFilterOptions["PastQuarter"] = "past_quarter";
    DateFilterOptions["PastYear"] = "past_year";
    DateFilterOptions["ComingWeek"] = "coming_week";
    DateFilterOptions["ComingMonth"] = "coming_month";
    DateFilterOptions["ComingQuarter"] = "coming_quarter";
    DateFilterOptions["ComingYear"] = "coming_year";
    DateFilterOptions["OnOrBefore"] = "on_or_before";
    DateFilterOptions["OnOrAfter"] = "on_or_after";
})(DateFilterOptions || (DateFilterOptions = {}));
class DateSelector$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
    ...
    render() {
        var _props = this.props;
        const filterValue = _props.filterValue,
        ...
        const showDatePredicate = dateFilterOption === DateFilterOptions.OnOrBefore || dateFilterOption === DateFilterOptions.OnOrAfter;
        const datePredicateMarkup = showDatePredicate && React.createElement(
            React.Fragment,
            null,
            React.createElement(
                'div',
                { className: styles$67.DateTextField },
            ...
            React.createElement(
                'div',
                { className: styles$67.DatePicker },
    ...
    get dateOptionTypes() {
        return {
            ...
            full: [...this.datePastOptions, ...this.dateFutureOptions, ...this.dateComparatorOptions]
        };
    }
    get now() {
        return new Date();
    ...
    get dateTextFieldValue() {
        var _state2 = this.state;
        const userInputDate = _state2.userInputDate,
    ...
    handleDateFilterOptionsChange(newOption) {
        var _props2 = this.props;
        const onFilterValueChange = _props2.onFilterValueChange,
              onFilterKeyChange = _props2.onFilterKeyChange,
              filterMinKey = _props2.filterMinKey,
              filterMaxKey = _props2.filterMaxKey;
        var _state3 = this.state;
        const initialConsumerFilterKey = _state3.initialConsumerFilterKey,
    ...
    handleDateFieldChange(value) {
        const onFilterValueChange = this.props.onFilterValueChange;
        const userInputDateError = this.state.userInputDateError;
    ...
    handleDateBlur() {
        var _props3 = this.props;
        const intl = _props3.polaris.intl,
              onFilterValueChange = _props3.onFilterValueChange;
        const userInputDate = this.state.userInputDate;
...
class FilterValueSelector extends React.PureComponent {
    componentDidMount() {
        ...
        const operatorText = _props$filter.operatorText,
    ...
    render() {
        ...
        const filter = _props.filter,
              ...
              intl = _props.polaris.intl;
        const operatorText = filter.operatorText;

        const showOperatorOptions = filter.type !== exports.FilterType.DateSelector && operatorText && typeof operatorText !== 'string';
        const operatorOptionsMarkup = showOperatorOptions ? React.createElement(Select$1, { label: filter.label, labelHidden: true, options: buildOperatorOptions(operatorText), value: filterKey, onChange: this.handleOperatorOptionChange }) : null;
        ...
        switch (filter.type) {
            ...
            case exports.FilterType.TextField:
                return React.createElement(
                    ...
                    { vertical: true },
                    operatorOptionsMarkup,
                    React.createElement(TextField$1, { label: selectedFilterLabel, value: value, type: filter.textFieldType, onChange: onChange })
                );
...
class FilterCreator extends React.PureComponent {
    ...
    render() {
        ...
        const filters = _props.filters,
              ...
              intl = _props.polaris.intl;
        var _state = this.state;
        const popoverActive = _state.popoverActive,
        ...
        const activator = React.createElement(
            Button$2,
        ...
        const filterValueSelectionMarkup = selectedFilter ? React.createElement(FilterValueSelector$1, { filter: selectedFilter, filterKey: selectedFilterKey, value: selectedFilterValue, onFilterKeyChange: this.handleFilterKeyChange, onChange: this.handleFilterValueChange }) : null;
        const addFilterButtonMarkup = selectedFilter ? React.createElement(
            Button$2,
    ...
    handleFilterKeyChange(filterKey) {
        ...
        const foundFilter = filters.find(filter => {
            ...
            if (operatorText && typeof operatorText !== 'string') {
                return filter.key === filterKey || operatorText.filter(({ key }) => key === filterKey).length === 1;
            }
    ...
    handleAddFilter() {
        const onAddFilter = this.props.onAddFilter;
        const selectedFilterKey = this.state.selectedFilterKey;
...
class FilterControl$1 extends React.Component {
    render() {
        var _context = this.context;
        const selectMode = _context.selectMode,
              resourceName = _context.resourceName;
        var _props = this.props;
        const searchValue = _props.searchValue;
        var _props$appliedFilters = _props.appliedFilters;
        const appliedFilters = _props$appliedFilters === undefined ? [] : _props$appliedFilters,
              additionalAction = _props.additionalAction;
        var _props$focused = _props.focused;
        const focused = _props$focused === undefined ? false : _props$focused;
        var _props$filters = _props.filters;
        const filters = _props$filters === undefined ? [] : _props$filters,
        ...
        const filterCreatorMarkup = filters.length > 0 ? React.createElement(FilterCreator$1, { resourceName: resourceName, filters: filters, onAddFilter: this.handleAddFilter, disabled: selectMode }) : null;
        const appliedFiltersMarkup = appliedFilters.map(appliedFilter => {
            ...
            return React.createElement(
                'li',
                { className: styles$68.AppliedFilter, key: filterId },
                React.createElement(
                    Tag$2,
                    { onRemove: this.getRemoveFilterCallback(filterId), disabled: selectMode },
                    activeFilterLabel
                )
            );
        });
        const appliedFiltersWrapper = appliedFilters.length > 0 ? React.createElement(
            'ul',
            { className: styles$68.AppliedFilters },
            appliedFiltersMarkup
        ) : null;
        return React.createElement(
            FormLayout$1,
            null,
            React.createElement(TextField$1, { connectedLeft: filterCreatorMarkup, connectedRight: additionalActionButton, label: textFieldLabel, labelHidden: true, placeholder: textFieldLabel, prefix: React.createElement(Icon$2, { source: 'search', color: 'skyDark' }), value: searchValue, onChange: onSearchChange, onBlur: onSearchBlur, focused: focused, disabled: selectMode }),
            appliedFiltersWrapper
        );
    }
    handleAddFilter(newFilter) {
        var _props2 = this.props;
        const onFiltersChange = _props2.onFiltersChange;
        var _props2$appliedFilter = _props2.appliedFilters;
        const appliedFilters = _props2$appliedFilter === undefined ? [] : _props2$appliedFilter;
    ...
    handleRemoveFilter(filterId) {
        var _props3 = this.props;
        const onFiltersChange = _props3.onFiltersChange;
        var _props3$appliedFilter = _props3.appliedFilters;
        const appliedFilters = _props3$appliedFilter === undefined ? [] : _props3$appliedFilter;
    ...
    getFilterLabel(appliedFilter) {
        ...
        const filters = _props$filters2 === undefined ? [] : _props$filters2;
        ...
        const filter = filters.find(filter => {
            ...
            if (operatorText && typeof operatorText !== 'string') {
                return filter.key === key || operatorText.filter(({ key: operatorKey }) => operatorKey === key).length === 1;
            }
    ...
    findFilterLabelByType(filter, appliedFilter) {
        const intl = this.props.polaris.intl;
        const appliedFilterValue = appliedFilter.value;
...
FilterControl$1.contextTypes = contextTypes$1;
...
var FilterControl$2 = withAppProvider()(FilterControl$1);

var styles$69 = {
  "CheckboxWrapper": "p_z3",
  "Item": "p_cp",
  "persistActions": "p_uy",
  "Actions": "p_x9",
  "selected": "p_ta",
...
const getUniqueCheckboxID = other.createUniqueIDFactory('ResourceListItemCheckbox');
class Item$13 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
    ...
    componentDidMount() {
        const subscribe = this.context.subscribe;
    ...
    render() {
        ...
        var _props$persistActions = _props.persistActions;
        const persistActions = _props$persistActions === undefined ? false : _props$persistActions,
              intl = _props.polaris.intl,
              accessibilityLabel = _props.accessibilityLabel;
        var _context = this.context;
        const selectable = _context.selectable,
              selectMode = _context.selectMode;
        var _state = this.state;
        const actionsMenuVisible = _state.actionsMenuVisible,
        ...
        const mediaMarkup = media ? React.createElement(
            'div',
            { className: styles$69.Media },
            media
        ) : null;
        const checkboxAccessibilityLabel = accessibilityLabel || intl.translate('Polaris.Common.checkbox');
        if (selectable) {
            const label = selected ? intl.translate('Polaris.ResourceList.Item.deselectItem', {
            ...
            handleMarkup = React.createElement(
                'div',
                { className: styles$69.Handle, onClick: this.handleLargerSelectionArea },
                React.createElement(
                    'div',
                    { onClick: stopPropagation, className: styles$69.CheckboxWrapper },
                    React.createElement(Checkbox$2, { id: this.checkboxId, label: label, labelHidden: true, onChange: this.handleSelection, checked: selected })
                )
            );
        }
        if (media || selectable) {
            ownedMarkup = React.createElement(
                'div',
                { className: styles$69.Owned },
                handleMarkup,
                mediaMarkup
            );
        }
        const className = styles.classNames(styles$69.Item, focused && styles$69.focused, selectable && styles$69.selectable, selected && styles$69.selected, selectMode && styles$69.selectMode, persistActions && styles$69.persistActions, focusedInner && styles$69.focusedInner);
        ...
        if (shortcutActions) {
            if (persistActions) {
                actionsMarkup = React.createElement(
                    'div',
                    { className: styles$69.Actions, onClick: stopPropagation },
                    React.createElement(
                        ButtonGroup$1,
                        null,
                ...
                disclosureMarkup = React.createElement(
                    'div',
                    { className: styles$69.Disclosure, onClick: stopPropagation },
                    React.createElement(
                        Popover$1,
                        { activator: React.createElement(Button$2, { 'aria-label': intl.translate('Polaris.ResourceList.Item.actionsDropdown'), onClick: this.handleActionsClick, plain: true, icon: 'horizontalDots' }), onClose: this.handleCloseRequest, active: actionsMenuVisible },
        ...
        const content = children ? React.createElement(
            'div',
            { className: styles$69.Content },
            children
        ) : null;
        const containerMarkup = React.createElement(
            'div',
            { className: styles$69.Container, id: this.props.id },
            ownedMarkup,
            content,
            actionsMarkup,
            disclosureMarkup
        );
        const accessibleMarkup = url ? React.createElement(UnstyledLink$2, { 'aria-describedby': this.props.id, 'aria-label': accessibilityLabel, className: styles$69.Link, url: url, onFocus: this.handleAnchorFocus, onBlur: this.handleFocusedBlur }) : React.createElement('button', { className: styles$69.Button, 'aria-label': accessibilityLabel, 'aria-controls': ariaControls, 'aria-expanded': ariaExpanded, onClick: this.handleClick, onFocus: this.handleAnchorFocus, onBlur: this.handleFocusedBlur });
        return React.createElement(
            'div',
    ...
    handleSelection(value) {
        ...
        const onSelectionChange = this.context.onSelectionChange;
    ...
    handleClick(event) {
        ...
        const selectMode = this.context.selectMode;
    ...
    handleKeypress(event) {
        ...
        const onClick = _props$onClick === undefined ? other.noop : _props$onClick;
        const selectMode = this.context.selectMode;
        const key = event.key;
...
Item$13.contextTypes = contextTypes$1;
tslib_1.__decorate([decorators.autobind], Item$13.prototype, "setNode", null);
tslib_1.__decorate([decorators.autobind], Item$13.prototype, "handleAnchorFocus", null);
tslib_1.__decorate([decorators.autobind], Item$13.prototype, "handleFocusedBlur", null);
tslib_1.__decorate([decorators.autobind], Item$13.prototype, "handleFocus", null);
tslib_1.__decorate([decorators.autobind], Item$13.prototype, "handleBlur", null);
tslib_1.__decorate([decorators.autobind], Item$13.prototype, "handleMouseDown", null);
tslib_1.__decorate([decorators.autobind], Item$13.prototype, "handleLargerSelectionArea", null);
tslib_1.__decorate([decorators.autobind], Item$13.prototype, "handleSelection", null);
tslib_1.__decorate([decorators.autobind], Item$13.prototype, "handleClick", null);
tslib_1.__decorate([decorators.autobind], Item$13.prototype, "handleKeypress", null);
tslib_1.__decorate([decorators.autobind], Item$13.prototype, "handleContextUpdate", null);
tslib_1.__decorate([decorators.autobind], Item$13.prototype, "handleActionsClick", null);
tslib_1.__decorate([decorators.autobind], Item$13.prototype, "handleCloseRequest", null);
function stopPropagation(event) {
    event.stopPropagation();
}
var Item$14 = withAppProvider()(Item$13);

var styles$70 = {
  "FiltersWrapper": "p_j8",
  "ResourceList": "p_g4",
  "HeaderOuterWrapper": "p_f4",
  "HeaderWrapper": "p_k9",
  "HeaderWrapper-isSticky": "p_ds",
  "HeaderContentWrapper": "p_j2",
  "HeaderWrapper-inSelectMode": "p_e1",
  "SortWrapper": "p_la",
  "HeaderWrapper-hasSelect": "p_hl",
  "HeaderWrapper-hasSort": "p_kf",
  "SortLabel": "p_fx",
  "ItemCountTextWrapper": "p_kl",
  "BulkActionsWrapper": "p_u4",
  "CheckableButtonWrapper": "p_er",
  "SelectButtonWrapper": "p_ou",
  "EmptySearchResultWrapper": "p_ks",
  "ResourceListWrapper": "p_yo",
  "ItemWrapper": "p_rv",
};

const SMALL_SCREEN_WIDTH = 458;
const getUniqueID$11 = other.createUniqueIDFactory('Select');
class ResourceList$1 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            selectMode: false,
    ...
    get selectable() {
        var _props = this.props;
        const promotedBulkActions = _props.promotedBulkActions,
    ...
    get bulkSelectState() {
        var _props2 = this.props;
        const selectedItems = _props2.selectedItems,
              items = _props2.items;
    ...
    get itemCountText() {
        var _props3 = this.props,
            _props3$resourceName = _props3.resourceName;
        const resourceName = _props3$resourceName === undefined ? this.defaultResourceName : _props3$resourceName,
              items = _props3.items,
              intl = _props3.polaris.intl;
    ...
    get bulkActionsLabel() {
        var _props4 = this.props,
            _props4$selectedItems = _props4.selectedItems;
        const selectedItems = _props4$selectedItems === undefined ? [] : _props4$selectedItems,
              items = _props4.items,
              intl = _props4.polaris.intl;
    ...
    get bulkActionsAccessibilityLabel() {
        var _props5 = this.props,
            _props5$resourceName = _props5.resourceName;
        const resourceName = _props5$resourceName === undefined ? this.defaultResourceName : _props5$resourceName;
        var _props5$selectedItems = _props5.selectedItems;
        const selectedItems = _props5$selectedItems === undefined ? [] : _props5$selectedItems,
              items = _props5.items,
              intl = _props5.polaris.intl;
    ...
    get paginatedSelectAllText() {
        var _props6 = this.props;
        const hasMoreItems = _props6.hasMoreItems,
              selectedItems = _props6.selectedItems,
              items = _props6.items;
        var _props6$resourceName = _props6.resourceName;
        const resourceName = _props6$resourceName === undefined ? this.defaultResourceName : _props6$resourceName,
              intl = _props6.polaris.intl;
    ...
    get paginatedSelectAllAction() {
        var _props7 = this.props;
        const hasMoreItems = _props7.hasMoreItems,
              selectedItems = _props7.selectedItems,
              items = _props7.items;
        var _props7$resourceName = _props7.resourceName;
        const resourceName = _props7$resourceName === undefined ? this.defaultResourceName : _props7$resourceName,
              intl = _props7.polaris.intl;

        if (!this.selectable || !hasMoreItems) {
            return;
        }
        const actionText = selectedItems === SELECT_ALL_ITEMS ? intl.translate('Polaris.Common.undo') : intl.translate('Polaris.ResourceList.selectAllItems', {
            itemsLength: items.length,
            resourceNamePlural: resourceName.plural
        });
        return {
    ...
    get emptySearchResultText() {
        ...
        const intl = _props8.polaris.intl;
        var _props8$resourceName = _props8.resourceName;
        const resourceName = _props8$resourceName === undefined ? this.defaultResourceName : _props8$resourceName;
    ...
    getChildContext() {
        ...
        const selectedItems = _props9.selectedItems;
        var _props9$resourceName = _props9.resourceName;
        const resourceName = _props9$resourceName === undefined ? this.defaultResourceName : _props9$resourceName;
    ...
    render() {
        ...
        const items = _props10.items,
              promotedBulkActions = _props10.promotedBulkActions,
              bulkActions = _props10.bulkActions,
              filterControl = _props10.filterControl;
        var _props10$showHeader = _props10.showHeader;
        const showHeader = _props10$showHeader === undefined ? false : _props10$showHeader,
              sortOptions = _props10.sortOptions,
              sortValue = _props10.sortValue,
              onSortChange = _props10.onSortChange,
              intl = _props10.polaris.intl;
        var _state = this.state;
        const selectMode = _state.selectMode;
        var _state$listNode = _state.listNode;
        const listNode = _state$listNode === undefined ? null : _state$listNode;

        const itemsExist = items.length > 0;
        const filterControlMarkup = filterControl ? React.createElement(
            'div',
            { className: styles$70.FiltersWrapper },
            filterControl
        ) : null;
        const bulkActionsMarkup = this.selectable ? React.createElement(
            'div',
            { className: styles$70.BulkActionsWrapper },
            React.createElement(BulkActions$2, { label: this.bulkActionsLabel, accessibilityLabel: this.bulkActionsAccessibilityLabel, selected: this.bulkSelectState, onToggleAll: this.handleToggleAll, selectMode: selectMode, onSelectModeToggle: this.handleSelectMode, promotedActions: promotedBulkActions, paginatedSelectAllAction: this.paginatedSelectAllAction, paginatedSelectAllText: this.paginatedSelectAllText, actions: bulkActions }),
            React.createElement(EventListener$1, { event: 'resize', handler: this.handleResize })
        ) : null;
        const selectId = getUniqueID$11();
        const sortingLabelMarkup = React.createElement(
            'label',
            { className: styles$70.SortLabel, htmlFor: selectId },
            intl.translate('Polaris.ResourceList.sortingLabel')
        );
        const sortingSelectMarkup = sortOptions && sortOptions.length > 0 ? React.createElement(
            'div',
            { className: styles$70.SortWrapper },
            sortingLabelMarkup,
        ...
        const itemCountTextMarkup = React.createElement(
            'div',
            { className: styles$70.ItemCountTextWrapper },
            this.itemCountText
        );
        const selectButtonMarkup = this.selectable ? React.createElement(
            'div',
            { className: styles$70.SelectButtonWrapper },
            React.createElement(
                Button$2,
        ...
        const checkableButtonMarkup = this.selectable ? React.createElement(
            'div',
            { className: styles$70.CheckableButtonWrapper },
            React.createElement(CheckableButton$2, { accessibilityLabel: this.bulkActionsAccessibilityLabel, label: this.itemCountText, onToggleAll: this.handleToggleAll, plain: true })
        ) : null;
        const needsHeader = this.selectable || sortOptions && sortOptions.length > 0;
        const headerMarkup = (showHeader || needsHeader) && listNode && itemsExist && React.createElement(
            'div',
            { className: styles$70.HeaderOuterWrapper },
            React.createElement(
                Sticky$1,
                { boundingElement: listNode },
                isSticky => {
                    const headerClassName = styles.classNames(styles$70.HeaderWrapper, sortOptions && sortOptions.length > 0 && styles$70['HeaderWrapper-hasSort'], this.selectable && styles$70['HeaderWrapper-hasSelect'], this.selectable && selectMode && styles$70['HeaderWrapper-inSelectMode'], isSticky && styles$70['HeaderWrapper-isSticky']);
                    return React.createElement(
                        'div',
                        { className: headerClassName },
                        React.createElement(
                            'div',
                            { className: styles$70.HeaderContentWrapper },
                            itemCountTextMarkup,
        ...
        const emptyStateMarkup = filterControl && !itemsExist ? React.createElement(
            'div',
            { className: styles$70.EmptySearchResultWrapper },
            React.createElement(EmptySearchResult$2, Object.assign({}, this.emptySearchResultText, { withIllustration: true }))
        ) : null;
        const listMarkup = itemsExist ? React.createElement(
            'ul',
            { className: styles$70.ResourceList, ref: this.setListNode, 'aria-live': 'polite' },
            items.map(this.renderItem)
        ) : emptyStateMarkup;
        return React.createElement(
            'div',
            { className: styles$70.ResourceListWrapper },
            filterControlMarkup,
            headerMarkup,
            listMarkup
        );
    ...
    handleSelectAllItemsInStore() {
        ...
        const onSelectionChange = _props11.onSelectionChange,
              selectedItems = _props11.selectedItems,
              items = _props11.items;
        var _props11$idForItem = _props11.idForItem;
        const idForItem = _props11$idForItem === undefined ? defaultIdForItem : _props11$idForItem;
    ...
    renderItem(item, index) {
        ...
        const renderItem = _props12.renderItem;
        var _props12$idForItem = _props12.idForItem;
        const idForItem = _props12$idForItem === undefined ? defaultIdForItem : _props12$idForItem;

        const id = idForItem(item, index);
        return React.createElement(
            'li',
            { key: id, className: styles$70.ItemWrapper },
            renderItem(item, id)
        );
    }
    handleSelectionChange(selected, id) {
        var _props13 = this.props;
        const onSelectionChange = _props13.onSelectionChange,
              selectedItems = _props13.selectedItems,
              items = _props13.items;
        var _props13$idForItem = _props13.idForItem;
        const idForItem = _props13$idForItem === undefined ? defaultIdForItem : _props13$idForItem;

        if (selectedItems == null || onSelectionChange == null) {
            return;
        }
        const newlySelectedItems = selectedItems === SELECT_ALL_ITEMS ? getAllItemsOnPage(items, idForItem) : [...selectedItems];
        if (selected) {
    ...
    handleToggleAll() {
        ...
        const onSelectionChange = _props14.onSelectionChange,
              selectedItems = _props14.selectedItems,
              items = _props14.items;
        var _props14$idForItem = _props14.idForItem;
        const idForItem = _props14$idForItem === undefined ? defaultIdForItem : _props14$idForItem;
...
ResourceList$1.Item = Item$14;
ResourceList$1.FilterControl = FilterControl$2;
ResourceList$1.childContextTypes = contextTypes$1;
tslib_1.__decorate([decorators.autobind], ResourceList$1.prototype, "bulkSelectState", null);
tslib_1.__decorate([decorators.autobind], ResourceList$1.prototype, "itemCountText", null);
...
tslib_1.__decorate([decorators.autobind], ResourceList$1.prototype, "subscribe", null);
tslib_1.__decorate([decorators.autobind], ResourceList$1.prototype, "unsubscribe", null);
tslib_1.__decorate([decorators.debounce(50), decorators.autobind], ResourceList$1.prototype, "handleResize", null);
tslib_1.__decorate([decorators.autobind], ResourceList$1.prototype, "setListNode", null);
...
class Sticky$1 extends React.Component {
    constructor() {
        super(...arguments);
        this.state = {
            isSticky: false,
    ...
    componentDidMount() {
        const stickyManager = this.context.polaris.stickyManager;
        var _props = this.props;
        const boundingElement = _props.boundingElement,
    ...
    render() {
        var _state = this.state;
        const style = _state.style,
              isSticky = _state.isSticky;
        const children = this.props.children;

        const childrenContent = typeof children === 'function' ? children(isSticky) : children;
        return React.createElement(
            'div',
            null,
...
var styles$71 = {
  ...
  "Item": "p_ia",
  "DisclosureTab": "p_hy",
  "DisclosureTab-visible": "p_rn",
  "DisclosureActivator": "p_ey",
  "TabMeasurer": "p_qt",
};

class Item$16 extends React.PureComponent {
    constructor() {
        super(...arguments);
    ...
    render() {
        ...
        const className = styles.classNames(styles$71.Item);
        return React.createElement(
            'li',
            { role: 'presentation' },
            React.createElement(
...
tslib_1.__decorate([decorators.autobind], Item$16.prototype, "setFocusedNode", null);

class List$2 extends React.PureComponent {
    render() {
        var _props = this.props;
        const focusIndex = _props.focusIndex,
        ...
        return React.createElement(
            'ul',
            { className: styles$71.List, onKeyDown: handleKeyDown$2, onKeyUp: this.handleKeypress },
            tabs
        );
    }
    handleKeypress(event) {
        var _props$onKeyPress = this.props.onKeyPress;
        const onKeyPress = _props$onKeyPress === undefined ? other.noop : _props$onKeyPress;
...
function Panel$1({ id, tabID, children }) {
  return React.createElement(
    'div',
    { className: styles$71.Panel, id: id, role: 'tabpanel', 'aria-labelledby': tabID, tabIndex: -1 },
    children
  );
}

class Tab$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.node = null;
    }
    ...
    componentDidUpdate(previousProps) {
        const wasSelected = previousProps.selected;
        var _props2 = this.props;
        const focused = _props2.focused,
    ...
    render() {
        ...
        const className = styles.classNames(styles$71.Tab, selected && styles$71['Tab-selected']);
        let tabIndex;
        ...
        const markup = url ? React.createElement(
            UnstyledLink$2,
        ...
        return React.createElement(
            'li',
            { role: 'presentation', className: styles$71.TabContainer, ref: this.setNode },
            markup
        );
    }
    setNode(node) {
...
class TabMeasurer$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
    ...
    render() {
        ...
        const classname = styles.classNames(styles$71.Tabs, styles$71.TabMeasurer);
        return React.createElement(
            'div',
    ...
    handleMeasurement() {
        ...
        const tabMeasurerNode = ReactDOM.findDOMNode(this);
...
class Tabs$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
            disclosureWidth: 0,
    ...
    componentWillReceiveProps(nextProps) {
        ...
        var _state = this.state;
        const disclosureWidth = _state.disclosureWidth,
        ...
        const visibleTabs = _getVisibleAndHiddenT.visibleTabs,
    ...
    render() {
        ...
        const classname = styles.classNames(styles$71.Tabs, fitted && styles$71.fitted, disclosureActivatorVisible && styles$71.fillSpace);
        const disclosureTabClassName = styles.classNames(styles$71.DisclosureTab, disclosureActivatorVisible && styles$71['DisclosureTab-visible']);
        const activator = React.createElement(
            'button',
            { tabIndex: -1, className: styles$71.DisclosureActivator, onClick: this.handleDisclosureActivatorClick },
    ...
    handleKeyPress(event) {
        var _state3 = this.state;
        const tabToFocus = _state3.tabToFocus,
    ...
    renderTabMarkup(tab, index) {
        const selected = this.props.selected;
        const tabToFocus = this.state.tabToFocus;
    ...
    handleFocus(event) {
        ...
        const target$$1 = event.target;
        if (target$$1.classList.contains(styles$71.Tab) || target$$1.classList.contains(styles$71.Item)) {
            let tabToFocus = -1;
        ...
        if (target$$1.classList.contains(styles$71.DisclosureActivator)) {
            return;
        }
        ...
        const relatedTarget = event.relatedTarget;
        if (!relatedTarget.classList.contains(styles$71.Tab) && !relatedTarget.classList.contains(styles$71.Item) && !relatedTarget.classList.contains(styles$71.DisclosureActivator)) {
            this.setState({ tabToFocus: selected });
        }
    }
    handleBlur(event) {
        ...
        const target$$1 = event.relatedTarget;
    ...
    handleMeasurement(measurements) {
        var _props3 = this.props;
        const tabs = _props3.tabs,
              selected = _props3.selected;
        const tabToFocus = this.state.tabToFocus;
        const tabWidths = measurements.hiddenTabWidths,
        ...
        const visibleTabs = _getVisibleAndHiddenT2.visibleTabs,
    ...
    handleTabClick(id) {
        var _props4 = this.props;
        const tabs = _props4.tabs;
        var _props4$onSelect = _props4.onSelect;
        const onSelect = _props4$onSelect === undefined ? other.noop : _props4$onSelect;
...
function Tag$1({ children, disabled = false, onRemove, polaris: { intl } }) {
  const className = reactUtilities.classNames(disabled && styles$72.disabled, styles$72.Tag);
  ...
  return React.createElement(
    ...
    React.createElement(
      'button',
      { type: 'button', 'aria-label': ariaLabel, className: styles$72.Button, onClick: onRemove, onMouseUp: handleMouseUpByBlurring, disabled: disabled },
...
class Resizer$1 extends React.PureComponent {
    constructor() {
        super(...arguments);
    ...
    render() {
        var _props = this.props;
        const contents = _props.contents,
              minimumLines = _props.minimumLines;

        const minimumLinesMarkup = minimumLines ? React.createElement('div', { ref: this.setMinimumLinesNode, className: styles$73.DummyInput, dangerouslySetInnerHTML: {
                __html: getContentsForMinimumLines(minimumLines)
            } }) : null;
        return React.createElement(
            'div',
            { 'aria-hidden': true, className: styles$73.Resizer },
            React.createElement(EventListener$1, { event: 'resize', handler: this.handleHeightCheck }),
            React.createElement('div', { ref: this.setContentNode, className: styles$73.DummyInput, dangerouslySetInnerHTML: { __html: getFinalContents(contents) } }),
            minimumLinesMarkup
        );
    }
    handleHeightCheck() {
        ...
        var _props2 = this.props;
        const currentHeight = _props2.currentHeight,
...
function Spinner$4({ onChange, onClick }) {
  function handleStep(step) {
    return () => onChange(step);
  }
  return React.createElement(
    'div',
    { className: styles$73.Spinner, onClick: onClick, 'aria-hidden': true },
    React.createElement(
      'div',
      { role: 'button', className: styles$73.Segment, tabIndex: -1, onClick: handleStep(1) },
      React.createElement(
        'div',
        { className: styles$73.SpinnerIcon },
...
const getUniqueID$13 = other.createUniqueIDFactory('TextField');
class TextField$1 extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            height: null,
            focus: false,
            id: props.id || getUniqueID$13()
        };
    }
    ...
    render() {
        var _props = this.props,
            _props$id = _props.id;
        const id = _props$id === undefined ? this.state.id : _props$id;
        ...
        const className = styles.classNames(styles$73.TextField, Boolean(value) && styles$73.hasValue, disabled && styles$73.disabled, readOnly && styles$73.readOnly, error && styles$73.error, multiline && styles$73.multiline, this.state.focus && styles$73.focus);
        const inputType = type === 'currency' ? 'text' : type;
        const prefixMarkup = prefix ? React.createElement(
            'div',
            { className: styles$73.Prefix, id: `${id}Prefix` },
            prefix
        ) : null;
        const suffixMarkup = suffix ? React.createElement(
            'div',
            { className: styles$73.Suffix, id: `${id}Suffix` },
            suffix
        ) : null;
        const spinnerMarkup = type === 'number' && !disabled ? React.createElement(Spinner$4, { onChange: this.handleNumberChange }) : null;
        const style = multiline && height ? { height } : null;
        const resizer = multiline ? React.createElement(Resizer$1, { contents: value || placeholder, currentHeight: height, minimumLines: typeof multiline === 'number' ? multiline : 1, onHeightChange: this.handleExpandingResize }) : null;
        const describedBy = [];
        if (error) {
            describedBy.push(`${id}Error`);
        }
        ...
        const inputClassName = styles.classNames(styles$73.Input, suffix && styles$73['Input-suffixed']);
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    suffixMarkup,
                    spinnerMarkup,
                    React.createElement('div', { className: styles$73.Backdrop }),
                    resizer
                )
            )
        );
    ...
    handleNumberChange(steps) {
        ...
        const step = _props2$step === undefined ? 1 : _props2$step;
        var _props2$min = _props2.min;
        const min = _props2$min === undefined ? -Infinity : _props2$min;
        var _props2$max = _props2.max;
        const max = _props2$max === undefined ? Infinity : _props2$max;
    ...
    handleKeyPress(event) {
        ...
        if (type !== 'number' || which === exports.Keys.ENTER || key.match(numbersSpec)) {
            return;
        }
        event.preventDefault();
    }
...
function Thumbnail$1({ source, alt, size = 'medium' }) {
    const className = styles.classNames(styles$74.Thumbnail, size && styles$74[styles.variationName('size', size)]);
    return React.createElement(
        'span',
        { className: className },
        React.createElement(Image$1, { alt: alt, source: source, className: styles$74.Image })
    );
}
...
function SkeletonDisplayText$1({ size = 'medium' }) {
    const className = styles.classNames(styles$75.DisplayText, size && styles$75[styles.variationName('size', size)]);
    return React.createElement('div', { className: className });
}

var styles$76 = {
  "SkeletonBodyTextContainer": "p_j3",
  "SkeletonBodyText": "p_vz",
};

function SkeletonBodyText$1({ lines = 3 }) {
    const bodyTextLines = [];
    for (let i = 0; i < lines; i++) {
        bodyTextLines.push(React.createElement('div', { className: styles$76.SkeletonBodyText, key: i }));
    }
    return React.createElement(
        'div',
        { className: styles$76.SkeletonBodyTextContainer },
        bodyTextLines
    );
}
...
var styles$77 = {
  ...
  "Content": "p_h4",
  "Header": "p_fq",
  "Header-hasSecondaryActions": "p_fl",
  "Actions": "p_zl",
  "Action": "p_v9",
};
...
class SkeletonPage extends React.PureComponent {
    render() {
        ...
        const title = _props$title === undefined ? '' : _props$title,
              breadcrumbs = _props.breadcrumbs;

        const className = styles.classNames(styles$77.Page, fullWidth && styles$77.fullWidth, singleColumn && styles$77.singleColumn);
        const headerClassName = styles.classNames(styles$77.Header, secondaryActions && styles$77['Header-hasSecondaryActions'], breadcrumbs && styles$77['Header-hasBreadcrumbs']);
        ...
        const headerMarkup = !this.props.polaris.easdk ? React.createElement(
            'div',
            { className: headerClassName },
            breadcrumbMarkup,
            titleMarkup,
...
function renderSecondaryActions(actionCount) {
    ...
    for (let i = 0; i < actionCount; i++) {
        ...
        actions.push(React.createElement(
            'div',
            { className: styles$77.Action, style: { width }, key: i },
...
function renderTitle(title) {
    const titleContent = title === '' ? React.createElement(SkeletonDisplayText$1, { size: 'large' }) : React.createElement(
        DisplayText$1,
        { size: 'large', element: 'h1' },
        title
    );
...
function ProgressBar$1({ progress = 0, size = 'medium', polaris: { intl } }) {
    const className = styles.classNames(styles$78.ProgressBar, size && styles$78[styles.variationName('size', size)]);
    const warningMessage = intl.translate(progress < 0 ? 'Polaris.ProgressBar.negativeWarningMessage' : 'Polaris.ProgressBar.exceedWarningMessage', { progress });
    const parsedProgress = parseProgress(progress, warningMessage);
    return React.createElement(
        'div',
        { className: className },
        React.createElement('progress', { className: styles$78.Progress, value: parsedProgress, max: '100' }),
        React.createElement(
            'div',
            { className: styles$78.Indicator, role: 'progressbar', 'aria-hidden': 'true', style: { width: `${parsedProgress}%` } },
            React.createElement(
                'span',
                { className: styles$78.Label },
                parsedProgress,
                '%'
            )
        )
